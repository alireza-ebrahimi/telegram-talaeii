...
public class StickyHeaderView extends FrameLayout implements C5301a {
    ...
    class C53001 extends C0944m {
        ...
        /* renamed from: a */
        public void m14092a(RecyclerView recyclerView, int i) {
            ...
            if (this.f10202a.f10206d == -1 || this.f10202a.f10207e == null || this.f10202a.f10208f == null) {
                ...
                if (adapter instanceof C5306e) {
                    ...
                    this.f10202a.f10207e.m14114a(this.f10202a);
        ...
        /* renamed from: a */
        public void m14093a(RecyclerView recyclerView, int i, int i2) {
            super.a(recyclerView, i, i2);
            if (this.f10202a.f10206d != -1 && this.f10202a.f10207e != null && this.f10202a.f10208f != null) {
                if (this.f10202a.f10209g.m14119c() && this.f10202a.f10207e.m14110a() != 0) {
                    this.f10202a.f10209g.m14117a(this.f10202a.f10207e.m14112a(this.f10202a.m14094a(0)));
                }
                int l = this.f10202a.f10208f.l();
                if (l != -1) {
                    int b = this.f10202a.m14094a(l);
                    int a = this.f10202a.f10207e.m14111a((C5304a) this.f10202a.f10209g.m14118b());
                    if (b - l <= 1) {
                        C5304a a2 = this.f10202a.f10207e.m14112a(b + 1);
                        ...
                        if (c != null) {
                            ...
                            if (top > 0 && top <= this.f10202a.f10206d) {
                                ...
                                if (b == a) {
                                    this.f10202a.f10209g.m14116a();
                                    if (!this.f10202a.f10209g.m14119c()) {
                                        this.f10202a.m14102a((C5304a) this.f10202a.f10209g.m14118b());
                                    }
                                }
                            } else if (top <= 0) {
                                this.f10202a.f10204b.setY(BitmapDescriptorFactory.HUE_RED);
                                this.f10202a.m14102a(this.f10202a.f10207e.m14112a(l));
                            }
                            if (b > a) {
                                this.f10202a.f10209g.m14117a(this.f10202a.f10207e.m14112a(b));
                            } else if (b < a) {
                                this.f10202a.f10209g.m14116a();
                            }
                        }
    ...
    /* renamed from: a */
    private int m14094a(int i) {
        while (i < this.f10207e.m14110a() && !this.f10207e.m14112a(i).shouldSticky()) {
            i++;
        }
        return i;
    }
    ...
    private void m14102a(C5304a c5304a) {
        ...
        b.bindView(this.f10207e, c0955v, this.f10207e.m14111a(c5304a), (C5302c) c5304a);
    }

    /* renamed from: b */
    private void m14105b() {
