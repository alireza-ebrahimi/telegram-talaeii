...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_10 'i' int) = (r1_9 'i' int), (r1_0 'i' int) binds: {(r1_0 'i' int)=B:15:0x0066, (r1_9 'i' int)=B:4:0x0011} in method: org.telegram.tgnet.SerializedData.readByteArray(boolean):byte[], dex: classes.dex
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0_7 'read' int) = (r0_6 'read' int), (r0_11 'read' int) binds: {(r0_11 'read' int)=B:15:0x0071, (r0_6 'read' int)=B:4:0x0011} in method: org.telegram.tgnet.SerializedData.readString(boolean):java.lang.String, dex: classes.dex
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:226)
	at jadx.core.codegen.RegionGen.makeLoop(RegionGen.java:184)
	at jadx.core.codegen.RegionGen.makeRegion(RegionGen.java:61)
	at jadx.core.codegen.RegionGen.makeSimpleRegion(RegionGen.java:87)
