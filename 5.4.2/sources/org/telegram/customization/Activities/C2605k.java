        ...
        public void onItemClick(View view, int i) {
            if (this.f8691a.getParentActivity() != null) {
                if (i == this.f8691a.f8694a) {
                    C3791b.m14002j(this.f8691a.getParentActivity(), TtmlNode.ANONYMOUS_REGION_ID);
                    C3791b.m13961d(this.f8691a.getParentActivity(), 1);
                } else if (i == this.f8691a.f8697d) {
                    C3791b.m14002j(this.f8691a.getParentActivity(), LocaleController.getString("un_silent_chats", R.string.un_silent_chats));
                    C3791b.m13961d(this.f8691a.getParentActivity(), 4);
                } else if (i == this.f8691a.f8696c) {
                    C3791b.m14002j(this.f8691a.getParentActivity(), LocaleController.getString("silent_chats", R.string.silent_chats));
                    C3791b.m13961d(this.f8691a.getParentActivity(), 3);
                } else if (i == this.f8691a.f8695b) {
                    C3791b.m14002j(this.f8691a.getParentActivity(), LocaleController.getString("unreadChats", R.string.unreadChats));
