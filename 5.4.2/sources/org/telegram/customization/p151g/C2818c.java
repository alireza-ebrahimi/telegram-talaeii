...
public class C2818c implements C2497d, Response$ErrorListener, Response$Listener<String> {
    ...
    private boolean m13106t(String str) {
        ...
        C3791b.m13977f(this.f9271h.mo3484e());
        this.f9274k++;
    ...
    public void m13110a(long j, long j2, boolean z, long j3, int i) {
        ...
        m13091a(new C2760a(this) {
            ...
            public Request mo3481b() {
                if (j4 == 0) {
                    C3791b.m14010l(this.f9222f.f9270g);
                }
                ...
                objArr[5] = Long.valueOf(C3791b.m14014m(this.f9222f.f9270g));
    ...
    public void m13112a(long j, String str, View view) {
        ...
        m13091a(new C2760a(this) {
            ...
            /* renamed from: b */
            public Request mo3481b() {
                return new StringRequest(this, 0, String.format(C3791b.m14043t(this.f9261d.f9270g) + "generalcontent/v5/getitem?newsId=%s&ParentTagId=%s", new Object[]{str2, Long.valueOf(j2)}), this.f9261d, this.f9261d) {
                    /* renamed from: a */
                ...
                public void mo3479a(C2757a c2757a) {
                    try {
                        ...
                        if (arrayList2.size() > 0) {
                            ...
                            C3791b.m14042s(ApplicationLoader.applicationContext, true);
                        }
                        if (z) {
    ...
    public void m13131d(String str) {
        m13091a(new C2760a(this) {
            ...
            /* renamed from: b */
            public Request mo3481b() {
                return new StringRequest(this, 0, C3791b.m14043t(this.f9102a.f9270g) + "election/v5/GetVoteResult", this.f9102a, this.f9102a) {
                    /* renamed from: a */
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(str) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        ...
                        C3791b.m14007k(this.f9109b.f9270g, System.currentTimeMillis());
        ...
        m13091a(new C2760a(this) {
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(str) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        C3791b.m14027p(this.f9112b.f9270g, System.currentTimeMillis());
        ...
        m13091a(new C2760a(this) {
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(str) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        C3791b.m14044t(this.f9115b.f9270g, System.currentTimeMillis());
        ...
        m13091a(new C2760a(this) {
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(str) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        C3791b.m14044t(this.f9118b.f9270g, System.currentTimeMillis());
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(c1771l) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        ...
                        C3791b.m13994i(this.f9122b.f9270g, System.currentTimeMillis());
                        return;
                    }
                    this.f9122b.f9272i.onResult(TtmlNode.ANONYMOUS_REGION_ID, -14);
                } catch (Exception e) {
                    e.printStackTrace();
                    C3791b.m13982g(this.f9122b.f9270g, 0);
                    C2757a c2757a2 = new C2757a();
                    c2757a2.m12802a(-1);
                    c2757a2.m12804a(TtmlNode.ANONYMOUS_REGION_ID);
        ...
        m13091a(new C2760a(this) {
            ...
            public void mo3479a(C2757a c2757a) {
                try {
                    ...
                    if (Integer.parseInt(str) == Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                        C3791b.m14001j(this.f9127b.f9270g, System.currentTimeMillis());
