...
public class C2666a extends Application implements C2497d {
    ...
    public void onCreate() {
        ...
        if (C3791b.m13907K(getApplicationContext()) == 0) {
            C3791b.m14036r(getApplicationContext(), System.currentTimeMillis());
        }
        C2827a.m13162a(getApplicationContext());
        int i = C3791b.m13993i((Context) this);
        if (i == 0 || i != BuildConfig.VERSION_CODE) {
            C3791b.m13975f(getApplicationContext(), TtmlNode.ANONYMOUS_REGION_ID);
            C3791b.m13930a(getApplicationContext(), TtmlNode.ANONYMOUS_REGION_ID);
            C3791b.m13936a(getApplicationContext(), false);
            C3791b.m14048u(getApplicationContext(), System.currentTimeMillis());
            C3791b.m13947b(getApplicationContext(), new ArrayList());
            try {
                OfficialJoinChannel S = C3791b.m13915S(ApplicationLoader.applicationContext);
                if (!(S == null || BuildConfig.FLAVOR.contentEquals("hotgram"))) {
                    if (BuildConfig.FLAVOR.contentEquals(BuildConfig.FLAVOR)) {
                        C3791b.m13934a(ApplicationLoader.applicationContext, S.getChannelUserName(), false);
                    }
                }
            } catch (Exception e) {
            }
