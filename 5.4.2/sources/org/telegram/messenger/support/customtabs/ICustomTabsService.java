    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 4:
                    parcel.enforceInterface(DESCRIPTOR);
                    warmup = mayLaunchUrl(org.telegram.messenger.support.customtabs.ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null, parcel.createTypedArrayList(Bundle.CREATOR));
                    parcel2.writeNoException();
                    if (warmup) {
                        i3 = 1;
                    }
                ...
                case 6:
                    parcel.enforceInterface(DESCRIPTOR);
                    warmup = updateVisuals(org.telegram.messenger.support.customtabs.ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (warmup) {
                        i3 = 1;
                    }
                ...
                case 7:
                    parcel.enforceInterface(DESCRIPTOR);
                    warmup = requestPostMessageChannel(org.telegram.messenger.support.customtabs.ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (warmup) {
                        i3 = 1;
                    }
                ...
                case 8:
                    parcel.enforceInterface(DESCRIPTOR);
                    int postMessage = postMessage(org.telegram.messenger.support.customtabs.ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
