...
public class LinearLayoutManager extends LayoutManager implements ScrollVectorProvider, ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C36681();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        /* renamed from: org.telegram.messenger.support.widget.LinearLayoutManager$SavedState$1 */
        static class C36681 implements Creator<SavedState> {
            C36681() {
            }
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        return this.mOrientation == 0 ? new PointF((float) i2, BitmapDescriptorFactory.HUE_RED) : new PointF(BitmapDescriptorFactory.HUE_RED, (float) i2);
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            ...
            a.m2479b(findFirstVisibleItemPosition());
            a.m2482c(findLastVisibleItemPosition());
        }
    }
    ...
    protected void recycleChildren(Recycler recycler, int i, int i2) {
        if (i != i2) {
            if (i2 > i) {
    ...
    protected void recycleViewsFromEnd(Recycler recycler, int i) {
        int childCount = getChildCount();
        if (i >= 0) {
