...
abstract class Atom {
    ...
    public static final int TYPE_data = Util.getIntegerCodeForString(DataBufferSafeParcelable.DATA_FIELD);
    ...
    static final class ContainerAtom extends Atom {
        ...
        public int getChildAtomOfTypeCount(int i) {
            ...
            int i4 = 0;
            while (i3 < size) {
                int i5 = ((LeafAtom) this.leafChildren.get(i3)).type == i ? i4 + 1 : i4;
                i3++;
                i4 = i5;
            }
            i3 = this.containerChildren.size();
            while (i2 < i3) {
                i5 = ((ContainerAtom) this.containerChildren.get(i2)).type == i ? i4 + 1 : i4;
                i2++;
                i4 = i5;
            }
            return i4;
