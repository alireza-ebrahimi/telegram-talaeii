...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private class InternalViewPagerListener implements C0188f {
        ...
        public void onPageScrolled(int i, float f, int i2) {
            ...
            if (childCount != 0 && i >= 0 && i < childCount) {
                this.f10290a.f10293a.m14189a(i, f);
                View childAt = this.f10290a.f10293a.getChildAt(i);
                this.f10290a.m14181b(i, childAt != null ? (int) (((float) childAt.getWidth()) * f) : 0);
                if (this.f10290a.f10301i != null) {
        ...
        public void onPageSelected(int i) {
            if (this.f10291b == 0) {
                this.f10290a.f10293a.m14189a(i, (float) BitmapDescriptorFactory.HUE_RED);
                this.f10290a.m14181b(i, 0);
            }
            int i2 = 0;
    ...
    private class TabClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            for (int i = 0; i < this.f10292a.f10293a.getChildCount(); i++) {
                if (view == this.f10292a.f10293a.getChildAt(i) && this.f10292a.m14185a()) {
    ...
    /* renamed from: b */
    private void m14181b(int i, int i2) {
    ...
    @TargetApi(14)
    /* renamed from: a */
    protected TextView m14183a(Context context) {
    ...
    /* renamed from: a */
    public void m14184a(int i, int i2) {
        this.f10295c = i;
        this.f10296d = i2;
    }

    /* renamed from: a */
    public boolean m14185a() {
        return this.f10298f;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.f10299g != null) {
            m14181b(this.f10299g.getCurrentItem(), 0);
        }
    }

    public void setCustomTabColorizer(TabColorizer tabColorizer) {
        this.f10293a.m14190a(tabColorizer);
    }
