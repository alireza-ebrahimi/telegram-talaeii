...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f10264p = new Property<CircularProgress, Float>(this, Float.class, "angle") {
            ...
            /* renamed from: a */
            public Float m14150a(CircularProgress circularProgress) {
                return Float.valueOf(circularProgress.getCurrentGlobalAngle());
            }

            /* renamed from: a */
            public void m14151a(CircularProgress circularProgress, Float f) {
                circularProgress.setCurrentGlobalAngle(f.floatValue());
            }

            public /* synthetic */ Object get(Object obj) {
                return m14150a((CircularProgress) obj);
            }

            public /* synthetic */ void set(Object obj, Object obj2) {
                m14151a((CircularProgress) obj, (Float) obj2);
            }
        };
    ...
    /* renamed from: a */
    private static int m14154a(int i, int i2, float f) {
    ...
    /* renamed from: c */
    private boolean m14158c() {
        return this.f10260l;
    }

    /* renamed from: d */
    private void m14159d() {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f10254f) {
            this.f10255g.setColor(m14154a(this.f10261m[this.f10262n], this.f10261m[this.f10263o], this.f10258j / 300.0f));
            f = f3 + 30.0f;
        } else {
            f2 += f3;
            f = (360.0f - f3) - 30.0f;
