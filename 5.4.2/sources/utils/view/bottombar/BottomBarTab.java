...
public class BottomBarTab extends LinearLayout {
    ...
    class C53423 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (!this.f10393a.f10431p && this.f10393a.f10416a != null) {
                this.f10393a.f10416a.m14268b(this.f10393a);
                this.f10393a.f10416a.m14266b();
            }
        }
    }
    ...
    public static class Config {
        ...
        public static class Builder {
            ...
            /* renamed from: a */
            public Builder m14278a(float f) {
                this.f10396a = f;
                return this;
            }

            /* renamed from: a */
            public Builder m14279a(int i) {
                this.f10398c = i;
                return this;
            }

            /* renamed from: a */
            public Builder m14280a(Typeface typeface) {
                this.f10403h = typeface;
                return this;
            }

            /* renamed from: a */
            public Config m14281a() {
                return new Config();
            }

            /* renamed from: b */
            public Builder m14282b(float f) {
                this.f10397b = f;
                return this;
            }

            /* renamed from: b */
            public Builder m14283b(int i) {
                this.f10399d = i;
                return this;
            }

            /* renamed from: c */
            public Builder m14284c(int i) {
                this.f10400e = i;
                return this;
            }

            /* renamed from: d */
            public Builder m14285d(int i) {
                this.f10401f = i;
                return this;
            }

            /* renamed from: e */
            public Builder m14286e(int i) {
                this.f10402g = i;
                return this;
            }
        }
    ...
    BottomBarTab(Context context) {
        super(context);
        this.f10417b = MiscUtils.m14344a(context, 6.0f);
        this.f10418c = MiscUtils.m14344a(context, 8.0f);
        this.f10419d = MiscUtils.m14344a(context, 16.0f);
    }

    /* renamed from: a */
    private void m14295a(float f) {
        ah.q(this.f10429n).a(150).a(f).c();
    }

    /* renamed from: a */
    private void m14296a(float f, float f2) {
    ...
    /* renamed from: a */
    private void m14297a(int i, int i2) {
    ...
    /* renamed from: b */
    private void m14301b(int i, int i2) {
        if (this.f10420e != Type.TABLET) {
    ...
    /* renamed from: a */
    void m14306a(float f, boolean z) {
        if (z) {
        ...
        if (!this.f10431p && this.f10416a != null) {
            this.f10416a.m14268b(this);
            this.f10416a.m14266b();
        }
    }

    /* renamed from: a */
    void m14307a(Bundle bundle) {
        setBadgeCount(bundle.getInt("STATE_BADGE_COUNT_FOR_TAB_" + getIndexInTabContainer()));
    }

    /* renamed from: a */
    void m14308a(boolean z) {
        this.f10431p = true;
        if (z) {
            m14301b(this.f10429n.getPaddingTop(), this.f10417b);
            m14295a(this.f10424i);
            m14296a(1.0f, this.f10424i);
            m14297a(this.f10425j, this.f10426k);
        } else {
            setTitleScale(1.0f);
        ...
        if (this.f10416a != null) {
            this.f10416a.m14269c();
        }
    }

    /* renamed from: b */
    void m14309b(boolean z) {
        this.f10431p = false;
        boolean z2 = this.f10420e == Type.SHIFTING;
        float f = z2 ? BitmapDescriptorFactory.HUE_RED : 0.86f;
        int i = z2 ? this.f10419d : this.f10418c;
        if (z) {
            m14301b(this.f10429n.getPaddingTop(), i);
            m14296a(f, this.f10423h);
            m14295a(this.f10423h);
            m14297a(this.f10426k, this.f10425j);
        } else {
            setTitleScale(f);
            setTopPadding(i);
    ...
    Bundle m14312d() {
        ...
        bundle.putInt("STATE_BADGE_COUNT_FOR_TAB_" + getIndexInTabContainer(), this.f10416a.m14262a());
        return bundle;
    }
    ...
    public void setBadgeCount(int i) {
        if (i > 0) {
            if (this.f10416a == null) {
                ...
                this.f10416a.m14265a(this, this.f10428m);
            }
            this.f10416a.m14263a(i);
        } else if (this.f10416a != null) {
            this.f10416a.m14264a(this);
            this.f10416a = null;
        }
    }
