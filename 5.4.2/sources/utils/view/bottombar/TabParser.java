...
class TabParser {
    ...
    /* renamed from: a */
    private String m14352a(int i, XmlResourceParser xmlResourceParser) {
    ...
    /* renamed from: a */
    private void m14353a(XmlResourceParser xmlResourceParser) {
        if (this.f10455e == null) {
            this.f10455e = m14356c();
        }
        ...
        for (int i = 0; i < xmlResourceParser.getAttributeCount(); i++) {
            ...
            switch (i2) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this.f10455e.setTitle(m14352a(i, xmlResourceParser));
                    break;
                case 3:
                    b = m14354b(i, xmlResourceParser);
                    if (b == null) {
                        break;
                    }
    ...
    /* renamed from: b */
    private Integer m14354b(int i, XmlResourceParser xmlResourceParser) {
        int attributeResourceValue = xmlResourceParser.getAttributeResourceValue(i, 0);
