...
final class NavbarUtils {
    ...
    /* renamed from: a */
    static int m14347a(Context context) {
    ...
    /* renamed from: b */
    static boolean m14348b(Context context) {
        return m14349c(context) && m14350d(context);
    }

    /* renamed from: c */
    private static boolean m14349c(Context context) {
        return context.getResources().getBoolean(R.bool.bb_bottom_bar_is_portrait_mode);
    }

    /* renamed from: d */
    private static boolean m14350d(Context context) {
