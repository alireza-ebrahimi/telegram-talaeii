...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.f10307e = m14187a(typedValue.data, (byte) 38);
        this.f10308f = new SimpleTabColorizer();
        this.f10308f.m14186a(-13388315);
    ...
    /* renamed from: a */
    private static int m14187a(int i, byte b) {
        return Color.argb(b, Color.red(i), Color.green(i), Color.blue(i));
    }

    /* renamed from: a */
    private static int m14188a(int i, int i2, float f) {
        float f2 = 1.0f - f;
    ...
    /* renamed from: a */
    void m14190a(TabColorizer tabColorizer) {
        this.f10311i = tabColorizer;
        invalidate();
    }

    /* renamed from: a */
    void m14191a(int... iArr) {
        this.f10311i = null;
        this.f10308f.m14186a(iArr);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            if (this.f10310h <= BitmapDescriptorFactory.HUE_RED || this.f10309g >= getChildCount() - 1) {
                ...
                if (indicatorColor != i) {
                    indicatorColor = m14188a(i, indicatorColor, this.f10310h);
                }
