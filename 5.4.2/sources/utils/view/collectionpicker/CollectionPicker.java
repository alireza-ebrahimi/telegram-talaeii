...
public class CollectionPicker extends LinearLayout {
    ...
    class C53493 implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (this.f10464d.m14372c()) {
                this.f10462b.setBackground(this.f10464d.m14368b(this.f10461a));
            } else {
                this.f10462b.setBackgroundDrawable(this.f10464d.m14368b(this.f10461a));
            }
            ((ImageView) this.f10462b.findViewById(R.id.item_icon)).setBackgroundResource(this.f10464d.m14358a(Boolean.valueOf(this.f10461a.f10525c)));
    ...
    /* renamed from: a */
    private int m14358a(Boolean bool) {
        return bool.booleanValue() ? this.f10479m : this.f10478l;
    }

    /* renamed from: a */
    private View m14361a(Item item) {
        View inflate = this.f10467a.inflate(R.layout.collection_picker_item_layout, this, false);
        if (m14372c()) {
            inflate.setBackground(m14368b(item));
        } else {
            inflate.setBackgroundDrawable(m14368b(item));
        }
        return inflate;
    }

    /* renamed from: a */
    private void m14362a(final View view) {
        view.setScaleY(1.0f);
        view.setScaleX(1.0f);
    ...
    /* renamed from: a */
    private void m14363a(View view, int i) {
    ...
    /* renamed from: a */
    private void m14364a(View view, LayoutParams layoutParams, boolean z, int i) {
    ...
    /* renamed from: b */
    private StateListDrawable m14368b(Item item) {
        return item.f10525c ? getSelectorSelected() : getSelectorNormal();
    }

    /* renamed from: b */
    private void m14370b(View view) {
        view.setScaleY(1.2f);
        view.setScaleX(1.2f);
            ...
            while (z < this.f10468b.size()) {
                ...
                a.setOnClickListener(new OnClickListener(this) {
                    ...
                    public void onClick(View view) {
                        ...
                        if (this.f10460d.m14372c()) {
                            a.setBackground(this.f10460d.m14368b(item));
                        } else {
                            a.setBackgroundDrawable(this.f10460d.m14368b(item));
                        }
                        ((ImageView) a.findViewById(R.id.item_icon)).setBackgroundResource(this.f10460d.m14358a(Boolean.valueOf(item.f10525c)));
                ...
                imageView.setBackgroundResource(m14358a(Boolean.valueOf(item.f10525c)));
                imageView.setPadding(0, this.f10476j, this.f10475i, this.f10477k);
                paddingLeft = ((float) ((Utils.m14394a(getContext(), 30) + this.f10474h) + this.f10475i)) + measureText;
                if (((float) this.f10472f) <= (f + paddingLeft) + ((float) Utils.m14394a(getContext(), 3))) {
                    f = (float) (getPaddingLeft() + getPaddingRight());
                    m14364a(a, itemLayoutParams, true, z);
                    z3 = z;
                } else {
                    if (z != z2) {
                    ...
                    m14364a(a, itemLayoutParams, false, z);
                    z3 = z2;
                }
                z++;
                f += paddingLeft;
