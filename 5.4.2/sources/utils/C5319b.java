...
public class C5319b {
    ...
    /* renamed from: a */
    public static int m14132a(DocAvailableInfo docAvailableInfo) {
    ...
    /* renamed from: a */
    public static String m14133a(int i) {
        switch (i) {
            case 0:
                return "Not Free";
            case 1:
    ...
    /* renamed from: a */
    public static String m14134a(int i, long j) {
    ...
    /* renamed from: a */
    public static void m14135a(final Context context, final TLRPC$messages_Messages tLRPC$messages_Messages, final long j) {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                C5319b.m14139b(context, tLRPC$messages_Messages, j);
            }
        }, 1000);
    }

    /* renamed from: a */
    public static void m14136a(ArrayList<DocAvailableInfo> arrayList) {
    ...
    /* renamed from: a */
    public static void m14137a(Map<String, String> map) {
    ...
    /* renamed from: b */
    public static String m14138b(DocAvailableInfo docAvailableInfo) {
        try {
    ...
    /* renamed from: b */
    public static void m14139b(Context context, TLRPC$messages_Messages tLRPC$messages_Messages, long j) {
        long j2;
        ...
        if (arrayList.size() > 0) {
            ...
            C5319b.m14136a(arrayList2);
            C2818c.a(context, new C53152()).a(arrayList2, j);
        }
    }

    /* renamed from: c */
    public static String m14140c(DocAvailableInfo docAvailableInfo) {
        try {
            if (f10231b.containsKey(docAvailableInfo)) {
    ...
    /* renamed from: d */
    public static String m14141d(DocAvailableInfo docAvailableInfo) {
        try {
            if (f10231b.containsKey(docAvailableInfo)) {
