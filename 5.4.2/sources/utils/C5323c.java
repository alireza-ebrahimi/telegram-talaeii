...
public class C5323c {
    /* renamed from: a */
    public static String m14142a(String str) {
    ...
    /* renamed from: a */
    public static void m14144a(String str, String str2) {
    ...
    /* renamed from: a */
    public static void m14145a(final ArrayList<Setting> arrayList, final Context context) {
        ...
        new Thread() {
            ...
            L_0x03fa:
                ...
                r0 = utils.C5323c.m14148c(r0);	 Catch:{ Exception -> 0x0438 }
            ...
            L_0x057c:
                ...
                utils.C5323c.m14147b(r1, r0);	 Catch:{ Exception -> 0x0594 }
                goto L_0x000a;
            L_0x0594:
                r0 = move-exception;
                r0.printStackTrace();	 Catch:{ Exception -> 0x0030 }
            ...
            L_0x0681:
                r1 = r3;	 Catch:{ Exception -> 0x0030 }
                r0 = r0.getValue();	 Catch:{ Exception -> 0x0030 }
                r0 = utils.C5323c.m14142a(r0);	 Catch:{ Exception -> 0x0030 }
                r4 = "set-1065";
                utils.p178a.C3791b.b(r1, r0, r4);	 Catch:{ Exception -> 0x0030 }
                goto L_0x000a;
            L_0x0693:
    ...
    /* renamed from: b */
    private static void m14147b(Context context, HotgramNotification hotgramNotification) {
        try {
    ...
    /* renamed from: c */
    private static JoinChannelModel m14148c(String str) {
        try {
