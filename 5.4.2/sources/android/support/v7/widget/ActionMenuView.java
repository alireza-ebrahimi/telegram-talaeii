    ...
    private void m4408c(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                c0900c.f2343e = z2;
                int a = m4407a(childAt, i6, c0900c.f2339a ? 1 : i4, childMeasureSpec, paddingTop);
                i8 = Math.max(i8, a);
                paddingLeft = c0900c.f2342d ? i9 + 1 : i9;
            ...
            while (i5 < childCount) {
                ...
                if ((((long) (1 << i5)) & j) != 0) {
                    if (obj3 != null && c0900c.f2343e && i4 == 1) {
                        childAt2.setPadding(this.f2357l + i6, 0, this.f2357l, 0);
                    }
                    c0900c.f2340b++;
                    c0900c.f2344f = true;
                    size = i4 - 1;
        ...
        if (paddingTop <= 0 || j == 0 || (paddingTop >= paddingLeft - 1 && obj == null && i8 <= 1)) {
            ...
            if (obj == null) {
                ...
                if (!((((long) (1 << (childCount - 1))) & j) == 0 || ((C0900c) getChildAt(childCount - 1).getLayoutParams()).f2343e)) {
                    f = bitCount - 0.5f;
                    paddingLeft = f <= BitmapDescriptorFactory.HUE_RED ? (int) (((float) (paddingTop * i6)) / f) : 0;
                    i4 = 0;
                    obj3 = obj4;
                    while (i4 < childCount) {
                        if ((((long) (1 << i4)) & j) != 0) {
        ...
        if (obj3 != null) {
            for (paddingLeft = 0; paddingLeft < childCount; paddingLeft++) {
                ...
                if (c0900c.f2344f) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(c0900c.f2341c + (c0900c.f2340b * i6), 1073741824), childMeasureSpec);
                }
            }
        }
        if (mode == 1073741824) {
