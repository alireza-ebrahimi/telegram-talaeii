...
public class ao extends ViewGroup {
    ...
    void m174b(int i, int i2) {
        ...
        while (i10 < virtualChildCount) {
            ...
            if (b == null) {
                ...
                if (mode == 1073741824 && c0899a2.width == 0 && c0899a2.f2337g > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    int i13 = i3;
                    m169a(b, i10, i, f2 == BitmapDescriptorFactory.HUE_RED ? this.f132f : 0, i2, 0);
                ...
                i11 = c0899a2.bottomMargin + c0899a2.topMargin;
                i12 = b.getMeasuredHeight() + i11;
                int a = bp.m5745a(i6, ah.m2816i(b));
                if (z) {
                    i6 = b.getBaseline();
                    if (i6 != -1) {
                ...
                i6 = Math.max(i5, i12);
                obj6 = (obj2 == null || c0899a2.height != -1) ? null : 1;
        ...
        if (z2 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i4 < virtualChildCount) {
                ...
                if (b2 == null) {
                    ...
                    if (obj5 != null) {
                        this.f132f = ((c0899a.rightMargin + (c0899a.leftMargin + i9)) + m170b(b2)) + this.f132f;
                        i3 = i4;
                    } else {
                        i11 = this.f132f;
                        this.f132f = Math.max(i11, (c0899a.rightMargin + ((i11 + i9) + c0899a.leftMargin)) + m170b(b2));
                        i3 = i4;
                    }
                }
                i4 = i3 + 1;
        ...
        i4 = (16777215 & a2) - this.f132f;
        int i16;
        if (obj4 != null || (i4 != 0 && f > BitmapDescriptorFactory.HUE_RED)) {
            if (this.f133g > BitmapDescriptorFactory.HUE_RED) {
                f = this.f133g;
            }
            iArr[3] = -1;
            ...
            while (i9 < virtualChildCount) {
                ...
                if (b3 == null) {
                    ...
                    if (f6 > BitmapDescriptorFactory.HUE_RED) {
                        ...
                        i8 = bp.m5745a(i15, ah.m2816i(b3) & Theme.ACTION_BAR_VIDEO_EDIT_COLOR);
                        f5 = f3;
                    } else {
                        i11 = i14;
                        i8 = i15;
                    ...
                    if (obj5 != null) {
                        ...
                        i4 = this.f132f;
                        this.f132f = Math.max(i4, (((b3.getMeasuredWidth() + i4) + c0899a.leftMargin) + c0899a.rightMargin) + m170b(b3));
                    }
                    obj = (mode2 == 1073741824 || c0899a.height != -1) ? null : 1;
                    i10 = c0899a.topMargin + c0899a.bottomMargin;
                    i14 = b3.getMeasuredHeight() + i10;
                    i7 = Math.max(i7, i14);
                    i10 = Math.max(i16, obj != null ? i10 : i14);
                    obj = (obj9 == null || c0899a.height != -1) ? null : 1;
                    if (z) {
                        i12 = b3.getBaseline();
                        if (i12 != -1) {
        ...
        setMeasuredDimension((Theme.ACTION_BAR_VIDEO_EDIT_COLOR & i6) | a2, ah.m2773a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i6 << 16));
        if (obj3 != null) {
