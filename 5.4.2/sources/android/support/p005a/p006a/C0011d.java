...
class C0011d {
    ...
    /* renamed from: android.support.a.a.d$a */
    ...
    /* renamed from: android.support.a.a.d$b */
    public static class C0010b {
        ...
        C0010b(char c, float[] fArr) {
            this.f22a = c;
            this.f23b = fArr;
        }

        C0010b(C0010b c0010b) {
            this.f22a = c0010b.f22a;
            this.f23b = C0011d.m16a(c0010b.f23b, 0, c0010b.f23b.length);
        }

        /* renamed from: a */
        private static void m8a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        ...
        /* renamed from: a */
        private static void m9a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0010b.m9a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0010b.m8a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        /* renamed from: a */
        private static void m10a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        C0010b.m9a(path, f10, f9, fArr2[i2 + 5], fArr2[i2 + 6], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != BitmapDescriptorFactory.HUE_RED, fArr2[i2 + 4] != BitmapDescriptorFactory.HUE_RED);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
                    ...
                    case 'V':
                        ...
                        break;
                    case 'a':
                        C0010b.m9a(path, f10, f9, fArr2[i2 + 5] + f10, fArr2[i2 + 6] + f9, fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != BitmapDescriptorFactory.HUE_RED, fArr2[i2 + 4] != BitmapDescriptorFactory.HUE_RED);
                        f3 = f10 + fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6] + f9;
                        f6 = f7;
                        f5 = f8;
        ...
        /* renamed from: a */
        public static void m11a(C0010b[] c0010bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0010bArr.length; i++) {
                C0010b.m10a(path, fArr, c, c0010bArr[i].f22a, c0010bArr[i].f23b);
                c = c0010bArr[i].f22a;
            }
        }
    }
    ...
    /* renamed from: a */
    private static int m12a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m13a(java.lang.String r7, int r8, android.support.p005a.p006a.C0011d.C0009a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f21b = r1;
    ...
    /* renamed from: a */
    private static void m14a(ArrayList<C0010b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0010b(c, fArr));
    }

    /* renamed from: a */
    public static boolean m15a(C0010b[] c0010bArr, C0010b[] c0010bArr2) {
        if (c0010bArr == null || c0010bArr2 == null || c0010bArr.length != c0010bArr2.length) {
            return false;
        }
        int i = 0;
        while (i < c0010bArr.length) {
            if (c0010bArr[i].f22a != c0010bArr2[i].f22a || c0010bArr[i].f23b.length != c0010bArr2[i].f23b.length) {
                return false;
            }
            i++;
        }
    ...
    /* renamed from: a */
    static float[] m16a(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    /* renamed from: a */
    public static C0010b[] m17a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0011d.m12a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0011d.m14a(arrayList, trim.charAt(0), C0011d.m20b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0011d.m14a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0010b[]) arrayList.toArray(new C0010b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0010b[] m18a(C0010b[] c0010bArr) {
        if (c0010bArr == null) {
            return null;
        }
        C0010b[] c0010bArr2 = new C0010b[c0010bArr.length];
        for (int i = 0; i < c0010bArr.length; i++) {
            c0010bArr2[i] = new C0010b(c0010bArr[i]);
        }
        return c0010bArr2;
    }

    /* renamed from: b */
    public static void m19b(C0010b[] c0010bArr, C0010b[] c0010bArr2) {
        for (int i = 0; i < c0010bArr2.length; i++) {
            c0010bArr[i].f22a = c0010bArr2[i].f22a;
            for (int i2 = 0; i2 < c0010bArr2[i].f23b.length; i2++) {
                c0010bArr[i].f23b[i2] = c0010bArr2[i].f23b[i2];
            }
        }
    }
