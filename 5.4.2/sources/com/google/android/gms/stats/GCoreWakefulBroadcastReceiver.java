...
public abstract class GCoreWakefulBroadcastReceiver extends C0429p {
    ...
    public static boolean completeWakefulIntent(Context context, Intent intent) {
        ...
        return C0429p.completeWakefulIntent(intent);
    }
    ...
    private static ComponentName zza(Context context, Intent intent) {
        ...
        return C0429p.startWakefulService(context, intent);
    }
}
