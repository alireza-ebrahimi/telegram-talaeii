...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        String join = getCallingPackages() == null ? TtmlNode.ANONYMOUS_REGION_ID : TextUtils.join(",", getCallingPackages());
        int deviceState = getDeviceState();
        String secondaryWakeLockName = getSecondaryWakeLockName() == null ? TtmlNode.ANONYMOUS_REGION_ID : getSecondaryWakeLockName();
        String hostPackage = getHostPackage() == null ? TtmlNode.ANONYMOUS_REGION_ID : getHostPackage();
        float beginPowerPercentage = getBeginPowerPercentage();
        String codePackage = getCodePackage() == null ? TtmlNode.ANONYMOUS_REGION_ID : getCodePackage();
