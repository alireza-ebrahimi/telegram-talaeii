...
public class C2401e {
    ...
    public C2401e m11854a(Map<String, String> map) {
        for (String str : map.keySet()) {
            String str2;
            String str3 = (String) map.get(str2);
            if (((long) str3.length()) > 4194304) {
                throw new IllegalArgumentException("Form field " + str2 + " size too large: " + str3.length() + " - max allowed: " + 4194304);
            }
        }
        try {
            str2 = C2401e.m11850a((Map) map, C3446C.UTF8_NAME);
