...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01421();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01432();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01421 implements ThreadFactory {
    ...
    class C01432 extends WorkerRunnable<Params, Result> {
        C01432() {
        }
