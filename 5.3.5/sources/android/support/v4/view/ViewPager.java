...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02321();
    ...
    private static final Interpolator sInterpolator = new C02332();
    ...
    private final Runnable mEndScrollRunnable = new C02343();
    ...
    static class C02321 implements Comparator<ItemInfo> {
        C02321() {
        }
    ...
    static class C02332 implements Interpolator {
        C02332() {
        }
    ...
    class C02354 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02354());
    }
