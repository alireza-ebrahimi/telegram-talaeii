...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C02212());
    public static final AbsSavedState EMPTY_STATE = new C02201();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C02201 extends AbsSavedState {
        C02201() {
            super();
        }
    }
    ...
    static class C02212 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02212() {
        }
