...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long iterations = (now - this.mStartTime) / FetchConst.DEFAULT_ON_UPDATE_INTERVAL;
            float rawProgress = ((float) ((now - this.mStartTime) % FetchConst.DEFAULT_ON_UPDATE_INTERVAL)) / 20.0f;
            if (!this.mRunning) {
