...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01874();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01885();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01863();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01896();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01841();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01852();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C01841 implements OnWindowAttachListener {
        C01841() {
        }
    ...
    class C01852 implements OnWindowFocusChangeListener {
        C01852() {
        }
    ...
    class C01863 extends BroadcastReceiver {
        C01863() {
        }
    ...
    class C01874 implements OnAudioFocusChangeListener {
        C01874() {
        }
    ...
    class C01885 implements OnGetPlaybackPositionListener {
        C01885() {
        }
    ...
    class C01896 implements OnPlaybackPositionUpdateListener {
        C01896() {
        }
