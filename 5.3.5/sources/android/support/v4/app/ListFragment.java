...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01372();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01361();
    ...
    class C01372 implements OnItemClickListener {
        C01372() {
        }
