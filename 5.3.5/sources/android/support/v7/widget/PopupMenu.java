...
public class PopupMenu {
    ...
    class C03581 implements Callback {
        C03581() {
        }
    ...
    class C03592 implements android.widget.PopupWindow.OnDismissListener {
        C03592() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0299R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03581());
        ...
        this.mPopup.setOnDismissListener(new C03592());
    }
