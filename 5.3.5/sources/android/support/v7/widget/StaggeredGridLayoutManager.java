...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C03841();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C03851();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C03851 implements Creator<FullSpanItem> {
                C03851() {
                }
