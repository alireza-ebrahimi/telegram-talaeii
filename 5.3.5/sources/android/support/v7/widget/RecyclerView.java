...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C03633();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03671();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03682();
        private int mWidth;
        ...
        class C03682 implements Callback {
            C03682() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0305R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0305R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0305R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0305R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0305R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C03633 implements Interpolator {
        C03633() {
        }
    ...
    class C03644 implements ProcessCallback {
        C03644() {
        }
    ...
    class C03655 implements Callback {
        C03655() {
        }
    ...
    class C03666 implements Callback {
        C03666() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03611();
        ...
        this.mItemAnimatorRunner = new C03622();
        this.mViewInfoProcessCallback = new C03644();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0305R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0305R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0305R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03655());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03666());
    }
