...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03754 implements OnFocusChangeListener {
        C03754() {
        }
    ...
    class C03765 implements OnLayoutChangeListener {
        C03765() {
        }
    ...
    class C03776 implements OnGlobalLayoutListener {
        C03776() {
        }
    ...
    class C03787 implements OnClickListener {
        C03787() {
        }
    ...
    class C03798 implements OnKeyListener {
        C03798() {
        }
    ...
    class C03809 implements OnEditorActionListener {
        C03809() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03811());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03811 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03811() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0299R.attr.autoCompleteTextViewStyle);
        }
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= 600 || (widthDp >= 640 && heightDp >= FetchService.QUERY_SINGLE)) {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0299R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C03721();
        this.mUpdateDrawableStateRunnable = new C03732();
        this.mReleaseCursorRunnable = new C03743();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03787();
        this.mTextKeyListener = new C03798();
        this.mOnEditorActionListener = new C03809();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0299R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0299R.styleable.SearchView_layout, C0299R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0299R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0299R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0299R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0299R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0299R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0299R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0299R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0299R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0299R.styleable.SearchView_suggestionRowLayout, C0299R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0299R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03754());
        setIconifiedByDefault(a.getBoolean(C0299R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0299R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0299R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0299R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0299R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0299R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0299R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03765());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03776());
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0299R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0299R.dimen.abc_dropdownitem_text_padding_left) : 0;
