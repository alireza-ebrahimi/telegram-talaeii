...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02961();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02972();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02983();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C02961 extends ViewPropertyAnimatorListenerAdapter {
        C02961() {
        }
    ...
    class C02972 extends ViewPropertyAnimatorListenerAdapter {
        C02972() {
        }
    ...
    class C02983 implements ViewPropertyAnimatorUpdateListener {
        C02983() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0299R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0299R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0299R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0299R.id.action_bar_container);
        ...
        if (a.getBoolean(C0299R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0299R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0299R.attr.actionBarWidgetTheme, outValue, true);
