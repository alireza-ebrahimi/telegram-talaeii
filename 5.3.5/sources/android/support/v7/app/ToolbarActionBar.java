...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02952();
    private final Runnable mMenuInvalidator = new C02941();
    ...
    class C02952 implements OnMenuItemClickListener {
        C02952() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0299R.layout.abc_list_menu_item_layout);
