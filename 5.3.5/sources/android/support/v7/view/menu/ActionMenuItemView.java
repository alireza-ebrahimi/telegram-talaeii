...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0299R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0299R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return widthDp >= FetchService.QUERY_SINGLE || ((widthDp >= 640 && ConfigurationHelper.getScreenHeightDp(getResources()) >= FetchService.QUERY_SINGLE) || config.orientation == 2);
    }
