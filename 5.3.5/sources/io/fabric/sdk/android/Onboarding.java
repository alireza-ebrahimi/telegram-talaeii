...
class Onboarding extends Kit<Boolean> {
    ...
    protected boolean onPreExecute() {
        try {
            ...
            Fabric.getLogger().mo4384e(Fabric.TAG, "Failed init", e);
            return false;
        }
    }
    ...
    protected Boolean doInBackground() {
        ...
        if (settingsData != null) {
            try {
                ...
                Fabric.getLogger().mo4384e(Fabric.TAG, "Error performing auto configuration.", e);
            }
        }
    ...
    private SettingsData retrieveSettingsData() {
        try {
            ...
            Fabric.getLogger().mo4384e(Fabric.TAG, "Error dealing with settings", e);
            return null;
        }
    }
    ...
    private boolean performAutoConfigure(String iconHash, AppSettingsData appSettings, Collection<KitInfo> sdkKits) {
        if (AppSettingsData.STATUS_NEW.equals(appSettings.status)) {
            ...
            Fabric.getLogger().mo4384e(Fabric.TAG, "Failed to create app with Crashlytics service.", null);
            return false;
            ...
            Fabric.getLogger().mo4381d(Fabric.TAG, "Server says an update is required - forcing a full App update.");
