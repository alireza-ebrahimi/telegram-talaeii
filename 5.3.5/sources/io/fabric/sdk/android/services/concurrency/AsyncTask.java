...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C08721();
    ...
    private final WorkerRunnable<Params, Result> worker = new C08732();

    /* renamed from: io.fabric.sdk.android.services.concurrency.AsyncTask$1 */
    static class C08721 implements ThreadFactory {
    ...
    class C08732 extends WorkerRunnable<Params, Result> {
        C08732() {
            super();
        }
