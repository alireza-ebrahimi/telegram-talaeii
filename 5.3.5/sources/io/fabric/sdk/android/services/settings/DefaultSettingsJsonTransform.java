...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private AppIconSettingsData buildIconDataFrom(JSONObject iconJson) throws JSONException {
        return new AppIconSettingsData(iconJson.getString(SettingsJsonConstants.ICON_HASH_KEY), iconJson.getInt(SettingsJsonConstants.ICON_WIDTH_KEY), iconJson.getInt("height"));
    }
    ...
    private JSONObject toIconJson(AppIconSettingsData icon) throws JSONException {
        return new JSONObject().put(SettingsJsonConstants.ICON_HASH_KEY, icon.hash).put(SettingsJsonConstants.ICON_WIDTH_KEY, icon.width).put("height", icon.height);
    }
