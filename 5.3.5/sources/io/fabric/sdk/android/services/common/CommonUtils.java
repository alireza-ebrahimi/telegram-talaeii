...
public class CommonUtils {
    ...
    public static final Comparator<File> FILE_MODIFIED_COMPARATOR = new C08651();
    ...
    static class C08651 implements Comparator<File> {
        C08651() {
        }
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(arch)) {
                Fabric.getLogger().mo4381d(Fabric.TAG, "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
...
*/
    ...
    L_0x0020:
        ...
        r4.mo4384e(r5, r6, r0);	 Catch:{ Exception -> 0x0020, all -> 0x0036 }
    ...
    L_0x003e:
        ...
        r7.mo4384e(r8, r9, r2);	 Catch:{ all -> 0x0063 }
        r7 = "Failed to close system file reader.";
        closeOrLog(r0, r7);
        goto L_0x003c;
    L_0x0063:
                ...
                if (!TextUtils.isEmpty(result)) {
                    ...
                    try {
                        if (result.endsWith("KB")) {
                            ...
                            Fabric.getLogger().mo4381d(Fabric.TAG, "Unexpected meminfo format while computing RAM: " + result);
                        }
                    } catch (NumberFormatException e) {
                        Fabric.getLogger().mo4384e(Fabric.TAG, "Unexpected meminfo format while computing RAM: " + result, e);
                    }
                }
    ...
    private static String hash(InputStream source, String sha1Instance) {
        try {
            ...
            Fabric.getLogger().mo4384e(Fabric.TAG, "Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bytes, String algorithm) {
        try {
            ...
            Fabric.getLogger().mo4384e(Fabric.TAG, "Could not create hashing algorithm: " + algorithm + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static void logControlled(Context context, String msg) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo4381d(Fabric.TAG, msg);
        }
    }

    public static void logControlledError(Context context, String msg, Throwable tr) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo4383e(Fabric.TAG, msg);
        }
    }
    ...
    public static void closeOrLog(Closeable c, String message) {
        if (c != null) {
            try {
                ...
                Fabric.getLogger().mo4384e(Fabric.TAG, message, e);
            }
        }
    }
    ...
    public static String resolveBuildId(Context context) {
        ...
        Fabric.getLogger().mo4381d(Fabric.TAG, "Build ID is: " + buildId);
        return buildId;
    }
    ...
    public static void logOrThrowIllegalStateException(String logTag, String errorMsg) {
        ...
        Fabric.getLogger().mo4394w(logTag, errorMsg);
    }
