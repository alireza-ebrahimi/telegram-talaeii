...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        C0658L.m33w("Can't define system cache directory! '%s' will be used.", "/data/data/" + context.getPackageName() + "/cache/");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (appCacheDir.mkdirs()) {
            try {
                ...
                C0658L.m32i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
                return appCacheDir;
            }
        }
        C0658L.m33w("Unable to create external cache directory", new Object[0]);
        return null;
    }
