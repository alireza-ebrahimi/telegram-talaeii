...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C05491();
    ...
    static class C05491 implements Comparator<Comparable> {
        C05491() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05501 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05501() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05511 extends LinkedTreeMapIterator<K> {
            C05511() {
                super();
            }
