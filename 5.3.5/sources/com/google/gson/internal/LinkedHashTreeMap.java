...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C05461();
    ...
    static class C05461 implements Comparator<Comparable> {
        C05461() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05471 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05471() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05481 extends LinkedTreeMapIterator<K> {
            C05481() {
                super();
            }
