...
public class zzhp {
    ...
    private static boolean zzb(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return zza(packageInfo, zzlwi, zzlwj);
        }
        return zza(packageInfo, zzlwi);
    }

    public static zzhp zzeu(Context context) {
        zzbq.checkNotNull(context);
        synchronized (zzhp.class) {
            if (zzlwh == null) {
                zzlwh = new zzhp(context);
            }
        }
        return zzlwh;
    }

    private static byte[] zzgf(String str) {
        try {
    ...
    private final PackageInfo zzog(String str) {
        try {
            return zzbih.zzdd(this.zzdlx).getPackageInfo(str, 64);
    ...
    @Hide
    public final boolean zzof(String str) {
        PackageInfo zzog = zzog(str);
        if (zzog == null) {
            return false;
        }
        if (zzs.zzci(this.zzdlx)) {
            return zzb(zzog, true);
        }
        boolean zzb = zzb(zzog, false);
        if (zzb || !zzb(zzog, true)) {
            return zzb;
        }
