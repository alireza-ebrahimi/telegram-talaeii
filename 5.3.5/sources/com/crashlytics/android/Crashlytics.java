...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    public void setDebugMode(boolean debug) {
        Fabric.getLogger().mo4394w(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        Fabric.getLogger().mo4394w(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfo) {
        Fabric.getLogger().mo4394w(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
