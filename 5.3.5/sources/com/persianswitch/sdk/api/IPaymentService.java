...
public interface IPaymentService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPaymentService {
        private static final String DESCRIPTOR = "com.persianswitch.sdk.api.IPaymentService";
        static final int TRANSACTION_getPaymentIntent = 3;
        static final int TRANSACTION_initSDK = 1;
        static final int TRANSACTION_registerUser = 2;
        ...
        public static IPaymentService asInterface(IBinder obj) {
            ...
            if (iin == null || !(iin instanceof IPaymentService)) {
                return new Proxy(obj);
            }
            return (IPaymentService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    _result = getPaymentIntent(_arg0);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
    ...
    Bundle getPaymentIntent(Bundle bundle) throws RemoteException;

    void initSDK(Bundle bundle) throws RemoteException;

    Bundle registerUser(Bundle bundle) throws RemoteException;
}
