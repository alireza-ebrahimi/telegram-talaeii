...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    /* renamed from: com.persianswitch.okio.Buffer$1 */
    class C07621 extends OutputStream {
        C07621() {
        }
    ...
    /* renamed from: com.persianswitch.okio.Buffer$2 */
    class C07632 extends InputStream {
        C07632() {
        }
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            byteCount = 1;
            min = 0;
        } else if ((b0 & 224) == PsExtractor.AUDIO_STREAM) {
            codePoint = b0 & 31;
            byteCount = 2;
            min = 128;
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        int width = v < 100000000 ? v < 10000 ? v < 100 ? v < 10 ? 1 : 2 : v < 1000 ? 3 : 4 : v < C0907C.MICROS_PER_SECOND ? v < 100000 ? 5 : 6 : v < 10000000 ? 7 : 8 : v < 1000000000000L ? v < 10000000000L ? v < C0907C.NANOS_PER_SECOND ? 9 : 10 : v < 100000000000L ? 11 : 12 : v < 1000000000000000L ? v < 10000000000000L ? 13 : v < 100000000000000L ? 14 : 15 : v < 100000000000000000L ? v < 10000000000000000L ? 16 : 17 : v < 1000000000000000000L ? 18 : 19;
        if (negative) {
            width++;
        }
