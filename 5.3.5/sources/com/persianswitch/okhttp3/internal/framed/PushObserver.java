...
public interface PushObserver {
    public static final PushObserver CANCEL = new C07531();

    /* renamed from: com.persianswitch.okhttp3.internal.framed.PushObserver$1 */
    static class C07531 implements PushObserver {
        C07531() {
        }
