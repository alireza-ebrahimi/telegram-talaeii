...
import com.persianswitch.okhttp3.internal.io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C07364();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C07331();
    ...
    /* renamed from: com.persianswitch.okhttp3.internal.DiskLruCache$1 */
    ...
    /* renamed from: com.persianswitch.okhttp3.internal.DiskLruCache$3 */
    class C07353 implements Iterator<Snapshot> {
    ...
    /* renamed from: com.persianswitch.okhttp3.internal.DiskLruCache$4 */
    static class C07364 implements Sink {
        C07364() {
        }
    ...
    private synchronized com.persianswitch.okhttp3.internal.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        /*
        r4 = this;
        r0 = 0;
        monitor-enter(r4);
        r4.initialize();	 Catch:{ all -> 0x003d }
        r4.checkNotClosed();	 Catch:{ all -> 0x003d }
        r4.validateKey(r5);	 Catch:{ all -> 0x003d }
        r2 = r4.lruEntries;	 Catch:{ all -> 0x003d }
        r1 = r2.get(r5);	 Catch:{ all -> 0x003d }
        r1 = (com.persianswitch.okhttp3.internal.DiskLruCache.Entry) r1;	 Catch:{ all -> 0x003d }
        r2 = -1;
    ...
    L_0x001b:
        r2 = r1.sequenceNumber;	 Catch:{ all -> 0x003d }
    ...
    L_0x0027:
        r2 = r1.currentEditor;	 Catch:{ all -> 0x003d }
        if (r2 != 0) goto L_0x0023;
    L_0x002d:
        r2 = r4.mostRecentTrimFailed;	 Catch:{ all -> 0x003d }
        if (r2 != 0) goto L_0x0035;
    L_0x0031:
        r2 = r4.mostRecentRebuildFailed;	 Catch:{ all -> 0x003d }
        if (r2 == 0) goto L_0x0040;
    L_0x0035:
        r2 = r4.executor;	 Catch:{ all -> 0x003d }
        r3 = r4.cleanupRunnable;	 Catch:{ all -> 0x003d }
        r2.execute(r3);	 Catch:{ all -> 0x003d }
        goto L_0x0023;
    L_0x003d:
        r2 = move-exception;
        monitor-exit(r4);
        throw r2;
    L_0x0040:
        r2 = r4.journalWriter;	 Catch:{ all -> 0x003d }
        r3 = "DIRTY";
        r2 = r2.writeUtf8(r3);	 Catch:{ all -> 0x003d }
        r3 = 32;
        r2 = r2.writeByte(r3);	 Catch:{ all -> 0x003d }
        r2 = r2.writeUtf8(r5);	 Catch:{ all -> 0x003d }
        r3 = 10;
        r2.writeByte(r3);	 Catch:{ all -> 0x003d }
        r2 = r4.journalWriter;	 Catch:{ all -> 0x003d }
        r2.flush();	 Catch:{ all -> 0x003d }
        r2 = r4.hasJournalErrors;	 Catch:{ all -> 0x003d }
        if (r2 != 0) goto L_0x0023;
    L_0x0061:
        if (r1 != 0) goto L_0x006e;
    L_0x0063:
        r1 = new com.persianswitch.okhttp3.internal.DiskLruCache$Entry;	 Catch:{ all -> 0x003d }
        r2 = 0;
        r1.<init>(r5);	 Catch:{ all -> 0x003d }
        r2 = r4.lruEntries;	 Catch:{ all -> 0x003d }
        r2.put(r5, r1);	 Catch:{ all -> 0x003d }
    L_0x006e:
        r0 = new com.persianswitch.okhttp3.internal.DiskLruCache$Editor;	 Catch:{ all -> 0x003d }
        r2 = 0;
        r0.<init>(r1);	 Catch:{ all -> 0x003d }
        r1.currentEditor = r0;	 Catch:{ all -> 0x003d }
        goto L_0x0023;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.persianswitch.okhttp3.internal.DiskLruCache.edit(java.lang.String, long):com.persianswitch.okhttp3.internal.DiskLruCache$Editor");
    }
