...
public final class HttpDate {
    ...
    private static final ThreadLocal<DateFormat> STANDARD_DATE_FORMAT = new C07561();

    /* renamed from: com.persianswitch.okhttp3.internal.http.HttpDate$1 */
    static class C07561 extends ThreadLocal<DateFormat> {
        C07561() {
        }
