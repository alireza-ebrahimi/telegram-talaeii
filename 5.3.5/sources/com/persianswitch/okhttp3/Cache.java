...
import com.persianswitch.okhttp3.internal.DiskLruCache;
import com.persianswitch.okhttp3.internal.DiskLruCache.Editor;
import com.persianswitch.okhttp3.internal.DiskLruCache.Snapshot;
...
public final class Cache implements Closeable, Flushable {
    ...
    /* renamed from: com.persianswitch.okhttp3.Cache$1 */
    class C07111 implements InternalCache {
        C07111() {
        }
    ...
    /* renamed from: com.persianswitch.okhttp3.Cache$2 */
    class C07122 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate = Cache.this.cache.snapshots();
        String nextUrl;

        C07122() throws IOException {
        }
