...
import com.persianswitch.okhttp3.Call.Factory;
...
public class OkHttpClient implements Cloneable, Factory {
    ...
    /* renamed from: com.persianswitch.okhttp3.OkHttpClient$1 */
    static class C07251 extends Internal {
        C07251() {
        }

        public void addLenient(com.persianswitch.okhttp3.Headers.Builder builder, String line) {
            builder.addLenient(line);
        }

        public void addLenient(com.persianswitch.okhttp3.Headers.Builder builder, String name, String value) {
    ...
    static {
        List connSpecs = new ArrayList(Arrays.asList(new ConnectionSpec[]{ConnectionSpec.MODERN_TLS, ConnectionSpec.COMPATIBLE_TLS}));
