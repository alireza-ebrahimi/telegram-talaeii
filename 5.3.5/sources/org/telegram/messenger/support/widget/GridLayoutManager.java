...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void onAnchorReady(Recycler recycler, State state, LinearLayoutManager$AnchorInfo anchorInfo, int itemDirection) {
    ...
    private void ensureAnchorIsInCorrectSpan(Recycler recycler, State state, LinearLayoutManager$AnchorInfo anchorInfo, int itemDirection) {
