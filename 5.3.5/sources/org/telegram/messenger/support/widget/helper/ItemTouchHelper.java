...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    final Runnable mScrollRunnable = new C18861();
    ...
    class C18861 implements Runnable {
        C18861() {
        }
    ...
    class C18905 implements ChildDrawingOrderCallback {
        C18905() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C18911();
        private static final Interpolator sDragViewScrollCapInterpolator = new C18922();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: org.telegram.messenger.support.widget.helper.ItemTouchHelper$Callback$1 */
        static class C18911 implements Interpolator {
            C18911() {
            }
        ...
        static class C18922 implements Interpolator {
            C18922() {
            }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C18905();
            }
