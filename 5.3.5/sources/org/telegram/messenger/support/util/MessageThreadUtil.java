...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C18741();
            ...
            class C18741 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem msg = C18751.this.mQueue.next();
                    while (msg != null) {
                        switch (msg.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C18761();
            ...
            class C18761 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C18772.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C18772.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C18772.this.mQueue.removeMessages(2);
                                    C18772.this.mQueue.removeMessages(3);
                        ...
                        C18772.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
