...
class FetchService$5 extends BroadcastReceiver {
    final /* synthetic */ FetchService this$0;

    FetchService$5(FetchService this$0) {
        this.this$0 = this$0;
    }

    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            FetchService.access$2100(this.this$0, FetchRunnable.getIdFromIntent(intent));
        }
        if (FetchService.access$2200(this.this$0).size() == 0) {
            FetchService.access$2300(this.this$0);
