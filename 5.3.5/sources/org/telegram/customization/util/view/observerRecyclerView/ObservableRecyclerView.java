...
public class ObservableRecyclerView extends RecyclerView implements Scrollable {
    ...
    private ScrollPositionChangesListener scrollListener = null;
    int totalItemCount;
    int visibleItemCount;

    static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C12672();
        public static final SavedState EMPTY_STATE = new C12661();
        ...
        static class C12661 extends SavedState {
            C12661() {
                super();
            }
        }
        ...
        static class C12672 implements Creator<SavedState> {
            C12672() {
            }
    ...
    public void setScrollPositionChangesListener(ScrollPositionChangesListener l) {
    ...
    public void setLoadingEnd(boolean isLoading) {
        this.isLoadingEnd = isLoading;
    }
    ...
    public void setLoadingStart(boolean isLoading) {
        this.isLoadingStart = isLoading;
    }

    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        super.onScrollChanged(l, t, oldl, oldt);
        try {
            if (!(getLayoutManager() == null || (this.isLoadingEnd && this.isLoadingStart))) {
                this.visibleItemCount = getLayoutManager().getChildCount();
                this.totalItemCount = getLayoutManager().getItemCount();
                if (getLayoutManager() instanceof LinearLayoutManager) {
                    LinearLayoutManager llm = (LinearLayoutManager) getLayoutManager();
                    this.pastVisiblesItems = llm.findFirstVisibleItemPosition();
                    boolean isOther = true;
                    if (!this.isLoadingStart && llm.findFirstCompletelyVisibleItemPosition() == 0) {
                        isOther = false;
                        this.isLoadingStart = true;
                        this.scrollListener.ReachedStart(this);
                    }
                    if (!this.isLoadingEnd && llm.findLastCompletelyVisibleItemPosition() == this.totalItemCount - 1) {
                        isOther = false;
                        this.isLoadingEnd = true;
                        this.scrollListener.ReachedEnd(this);
                    }
                    if (!(!isOther || llm.findFirstCompletelyVisibleItemPosition() == 0 || llm.findLastCompletelyVisibleItemPosition() == this.totalItemCount - 1)) {
                        this.scrollListener.LeavedBoundaries(this, t);
                    }
        ...
        if (this.mCallbacks != null && getChildCount() > 0) {
            ...
            while (i <= lastVisiblePosition) {
                if (getChildAt(j) != null && (this.mChildrenHeights.indexOfKey(i) < 0 || getChildAt(j).getHeight() != this.mChildrenHeights.get(i))) {
            ...
            if (firstVisibleChild != null) {
                ...
                if (this.scrollListener != null) {
                    this.scrollListener.handleScrollState(this.mScrollState);
                }
    ...
    public boolean canScrollVertically(int direction) {
        return isCanScrollVertically() && super.canScrollVertically(direction);
    }
}
