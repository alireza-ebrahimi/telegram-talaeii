...
public class WidthImageAdapter extends PagerAdapter implements OnClickListener {
    private final Activity act;
    Context context;
    ArrayList<String> imageUrls = new ArrayList();
    LayoutInflater inflater;

    public WidthImageAdapter(Context context, Activity activity, ArrayList<String> newImageUrls) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = this.inflater.inflate(R.layout.screen_shot_full_item, null);
        ...
        Log.d("sadegh", "imagevieweract url2:" + url);
        if (url != null) {
            ...
            ((ExtendedViewPager) container).addView(view, 0);
        }
        return view;
    }
