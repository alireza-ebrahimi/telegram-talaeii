...
class HandleRequest$28 implements HandleRequest$HandleInterface {
    final /* synthetic */ HandleRequest this$0;
    final /* synthetic */ String val$json;

    HandleRequest$28(HandleRequest this$0, String str) {
        this.this$0 = this$0;
        this.val$json = str;
    }
    ...
    public Request getRequest() {
        ...
        return new BaseStringRequest(1, String.format(WebservicePropertis.WS_POST_SEND_TRAFFIC, new Object[]{Integer.valueOf(userId)}), this.this$0, this.this$0, HandleRequest.access$400(this.this$0), getSetKey()) {
            ...
            public byte[] getBody() throws AuthFailureError {
                return HandleRequest.getEncondedByteArr(HandleRequest$28.this.val$json);
            }
        };
    }
