...
class HandleRequest$46 implements HandleRequest$HandleInterface {
    final /* synthetic */ HandleRequest this$0;
    final /* synthetic */ String val$paymentId;

    HandleRequest$46(HandleRequest this$0, String str) {
        this.this$0 = this$0;
    ...
    public void onResponse(BaseResponseModel object) {
        ...
        if (hostRequestData != null) {
            HandleRequest.access$300(this.this$0).onResult(hostRequestData, 31);
        }
    }

    public void onErrorResponse(VolleyError volleyError) {
        HandleRequest.access$300(this.this$0).onResult(null, -31);
    }

    public Request getRequest() {
        return new BaseStringRequest(1, String.format(WebservicePropertis.WS_REQUEST_PAYMENT, new Object[]{this.val$paymentId}), this.this$0, this.this$0, HandleRequest.access$400(this.this$0), getSetKey()) {
