...
class HandleRequest$30 implements HandleRequest$HandleInterface {
    final /* synthetic */ HandleRequest this$0;
    final /* synthetic */ String val$json;

    HandleRequest$30(HandleRequest this$0, String str) {
        this.this$0 = this$0;
        this.val$json = str;
    }
    ...
    public void onResponse(BaseResponseModel object) {
        try {
            ...
            if (Integer.parseInt(itemsJson) == 200) {
                AppPreferences.setLastSuccessFullyTimeSyncLocation(HandleRequest.access$400(this.this$0), System.currentTimeMillis());
    ...
    public Request getRequest() {
        ...
        return new BaseStringRequest(1, String.format(WebservicePropertis.WS_POST_SEND_LOCATION, new Object[]{Integer.valueOf(userId)}), this.this$0, this.this$0, HandleRequest.access$400(this.this$0), getSetKey()) {
            ...
            public byte[] getBody() throws AuthFailureError {
                return HandleRequest.getEncondedByteArr(HandleRequest$30.this.val$json);
            }
