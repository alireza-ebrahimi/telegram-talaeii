...
public class SlsThreeTileSameHolder extends HolderBase {
    ...
    public SlsThreeTileSameHolder(Activity activity, ViewGroup viewGroup, DynamicAdapter adapter, ExtraData extraData) {
        super(activity, viewGroup, R.layout.home_tile_3_same, adapter, extraData);
    }
