...
public class AnimatedFileDrawable extends BitmapDrawable implements Animatable {
    ...
    private Runnable loadFrameRunnable = new C24833();
    private Runnable loadFrameTask;
    protected final Runnable mInvalidateTask = new C24811();
    private final Runnable mStartTask = new C24844();
    ...
    private Runnable uiRunnable = new C24822();
    ...
    class C24822 implements Runnable {
        C24822() {
        }
    ...
    class C24844 implements Runnable {
        C24844() {
        }
