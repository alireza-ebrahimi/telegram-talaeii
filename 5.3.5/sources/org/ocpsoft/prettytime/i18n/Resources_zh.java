...
public class Resources_zh extends ListResourceBundle {
    ...
    static {
        ...
        r0[2] = new Object[]{"CenturyFutureSuffix", "后"};
        r0[3] = new Object[]{"CenturyPastPrefix", ""};
        r0[4] = new Object[]{"CenturyPastSuffix", "前"};
        r0[5] = new Object[]{"CenturySingularName", "世纪"};
        r0[6] = new Object[]{"CenturyPluralName", "世纪"};
        r0[7] = new Object[]{"DayPattern", "%n %u"};
        r0[8] = new Object[]{"DayFuturePrefix", ""};
        r0[9] = new Object[]{"DayFutureSuffix", "后"};
        ...
        r0[16] = new Object[]{"DecadeFutureSuffix", "后"};
        ...
        r0[23] = new Object[]{"HourFutureSuffix", "后"};
        r0[24] = new Object[]{"HourPastPrefix", ""};
        r0[25] = new Object[]{"HourPastSuffix", "前"};
        r0[26] = new Object[]{"HourSingularName", "小时"};
        r0[27] = new Object[]{"HourPluralName", "小时"};
        r0[28] = new Object[]{"JustNowPattern", "%u"};
        r0[29] = new Object[]{"JustNowFuturePrefix", ""};
        r0[30] = new Object[]{"JustNowFutureSuffix", "刚刚"};
        ...
        r0[37] = new Object[]{"MillenniumFutureSuffix", "后"};
        ...
        r0[44] = new Object[]{"MillisecondFutureSuffix", "后"};
        ...
        r0[72] = new Object[]{"WeekFutureSuffix", "后"};
        r0[73] = new Object[]{"WeekPastPrefix", ""};
        r0[74] = new Object[]{"WeekPastSuffix", "前"};
        r0[75] = new Object[]{"WeekSingularName", "周"};
        r0[76] = new Object[]{"WeekPluralName", "周"};
        r0[77] = new Object[]{"YearPattern", "%n %u"};
        r0[78] = new Object[]{"YearFuturePrefix", ""};
        r0[79] = new Object[]{"YearFutureSuffix", "后"};
