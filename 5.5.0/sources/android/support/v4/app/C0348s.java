...
public class C0348s extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo286a(this.mBackStackId, 1);
                this.mBackStackId = -1;
                return;
            }
            aa a = getFragmentManager().mo284a();
            a.mo246a(this);
            if (z) {
                a.mo249b();
            } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m1510i().getSystemService("layout_inflater");
        }
    ...
    public int show(aa aaVar, String str) {
        ...
        aaVar.mo247a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = aaVar.mo244a();
