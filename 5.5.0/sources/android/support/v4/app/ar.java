...
class ar {
    ...
    /* renamed from: android.support.v4.app.ar$a */
    public static class C0291a implements ak {
        /* renamed from: a */
        private Builder f951a;

        public C0291a(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z) {
        ...
        public Notification mo229b() {
            return this.f951a.getNotification();
        }
    }
}
