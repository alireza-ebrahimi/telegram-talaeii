...
public class C2601j extends BaseFragment implements C2069c {
    ...
    public View createView(Context context) {
        ...
        if (!TextUtils.isEmpty(C3791b.m13974f(getParentActivity()))) {
            this.f8684a = C3791b.m13974f(getParentActivity());
        }
        if (!TextUtils.isEmpty(C3791b.m13981g(getParentActivity()))) {
            this.f8685b = C3791b.m13981g(getParentActivity());
        }
                ...
                if (this.f8681c.getParentActivity() != null) {
                    ...
                    if (i == 0) {
                        ...
                        if (view instanceof TextCheckCell) {
                            ...
                            C3791b.m14022n(parentActivity, z);
                        }
                        ...
                        if (view instanceof TextCheckCell) {
                            ...
                            C3791b.m14027o(parentActivity, z);
                        }
                    } else if (i == 4) {
                        ...
                        if (view instanceof TextCheckCell) {
                            ...
                            C3791b.m14031p(parentActivity, z);
                        }
                    }
                }
            }
