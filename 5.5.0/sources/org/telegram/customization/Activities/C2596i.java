...
public class C2596i extends BaseFragment implements NotificationCenterDelegate {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == 1) {
                ...
                if (i == this.f8623a.f8631G) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString("ShowUnreadDialogsAtTop", R.string.ShowUnreadDialogsAtTop), C3791b.m13973e(this.f8624b), true);
                    return emptyCell;
    ...
    private Builder m12386a(Builder builder) {
        ...
        final ArrayList u = C3791b.m14049u(getParentActivity());
        ...
        builder.setMultiChoiceItems(charSequenceArr, zArr, new OnMultiChoiceClickListener(this) {
            ...
            public void onClick(DialogInterface dialogInterface, int i, boolean z) {
                ...
                C3791b.m13996i(this.f8619b.getParentActivity(), new C1768f().m8395a(u));
                Iterator it = u.iterator();
                boolean z2 = false;
                while (it.hasNext()) {
        ...
        this.f8652b.setOnItemClickListener(new OnItemClickListener(this) {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                if (i == this.f8617b.f8630F) {
                    ...
                    C3791b.m14040r(ApplicationLoader.applicationContext, !r1);
                    if (view instanceof TextCheckCell) {
                    ...
                    for (int i2 = 0; i2 < strArr.length; i2++) {
                        ...
                        if (C3791b.m14056w(ApplicationLoader.applicationContext) == i2) {
