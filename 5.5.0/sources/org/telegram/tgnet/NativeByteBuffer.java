...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_10 'i' int) = (r1_9 'i' int), (r1_0 'i' int) binds: {(r1_0 'i' int)=B:15:0x0080, (r1_9 'i' int)=B:4:0x000f} in method: org.telegram.tgnet.NativeByteBuffer.readByteBuffer(boolean):org.telegram.tgnet.NativeByteBuffer, dex: classes.dex
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:226)
	at jadx.core.codegen.RegionGen.makeLoop(RegionGen.java:184)
	at jadx.core.codegen.RegionGen.makeRegion(RegionGen.java:61)
	at jadx.core.codegen.RegionGen.makeSimpleRegion(RegionGen.java:87)
