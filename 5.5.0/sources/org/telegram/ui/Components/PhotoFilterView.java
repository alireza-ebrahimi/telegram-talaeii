...
public class PhotoFilterView extends FrameLayout {
    ...
    class C45121 implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            if (PhotoFilterView.this.eglThread != null) {
                PhotoFilterView.this.eglThread.setSurfaceTextureSize(i, i2);
                PhotoFilterView.this.eglThread.requestRender(false, true);
                PhotoFilterView.this.eglThread.postRunnable(new C45111());
            }
        }
    ...
    class C45132 implements PhotoFilterLinearBlurControlDelegate {
        C45132() {
        }
    ...
    class C45143 implements PhotoFilterCurvesControlDelegate {
        C45143() {
        }
    ...
    class C45154 implements OnClickListener {
        C45154() {
        }
    ...
    class C45165 implements OnClickListener {
        C45165() {
        }
    ...
    class C45176 implements OnClickListener {
        C45176() {
        }
    ...
    class C45187 implements OnClickListener {
        C45187() {
        }
        ...
        public void onClick(View view) {
            ...
            int i = 0;
            while (i < 4) {
                PhotoFilterView.this.curveRadioButton[i].setChecked(i == intValue, true);
                i++;
            }
    ...
    class C45198 implements OnClickListener {
        C45198() {
        }
    ...
    class C45209 implements OnClickListener {
        C45209() {
        }
    ...
    public static class CurvesValue {
        ...
        public float[] interpolateCurve() {
            int i;
            float[] fArr = new float[]{-0.001f, this.blacksLevel / 100.0f, BitmapDescriptorFactory.HUE_RED, this.blacksLevel / 100.0f, 0.25f, this.shadowsLevel / 100.0f, 0.5f, this.midtonesLevel / 100.0f, 0.75f, this.highlightsLevel / 100.0f, 1.0f, this.whitesLevel / 100.0f, 1.001f, this.whitesLevel / 100.0f};
            ...
            for (int i2 = 1; i2 < (fArr.length / 2) - 2; i2++) {
                float f = fArr[(i2 - 1) * 2];
                float f2 = fArr[((i2 - 1) * 2) + 1];
                float f3 = fArr[i2 * 2];
                float f4 = fArr[(i2 * 2) + 1];
                float f5 = fArr[(i2 + 1) * 2];
                float f6 = fArr[((i2 + 1) * 2) + 1];
                float f7 = fArr[(i2 + 2) * 2];
                float f8 = fArr[((i2 + 2) * 2) + 1];
                for (i = 1; i < 100; i++) {
                    ...
                    float f13 = 1.0f;
                    f9 = Math.max(BitmapDescriptorFactory.HUE_RED, Math.min(f13, ((((f9 * (f6 - f2)) + (2.0f * f4)) + (f10 * ((((2.0f * f2) - (5.0f * f4)) + (4.0f * f6)) - f8))) + (((((3.0f * f4) - f2) - (3.0f * f6)) + f8) * f11)) * 0.5f));
                    if (f12 > f) {
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C45211();
        private EGL10 egl10;
        ...
        class C45211 implements Runnable {
            C45211() {
            }
        ...
        class C45233 implements Runnable {
            C45233() {
            }
        ...
        private boolean drawBlurPass() {
            ...
            if (this.needUpdateBlurTexture) {
                ...
                GLES20.glUniform1f(this.blurWidthHandle, BitmapDescriptorFactory.HUE_RED);
                ...
                GLES20.glUniform1f(this.blurHeightHandle, BitmapDescriptorFactory.HUE_RED);
                GLES20.glDrawArrays(5, 0, 4);
            ...
            if (PhotoFilterView.this.blurType == 1) {
                ...
                GLES20.glUniform2f(this.radialBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f10184x, PhotoFilterView.this.blurExcludePoint.f10185y);
                ...
                GLES20.glUniform2f(this.linearBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f10184x, PhotoFilterView.this.blurExcludePoint.f10185y);
                ...
                if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                    ...
                    if (this.eglContext == null) {
                        ...
                        if (this.eglSurface == null || this.eglSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            fArr = new float[]{BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f, 1.0f, 1.0f};
                            allocateDirect = ByteBuffer.allocateDirect(fArr.length * 4);
                            allocateDirect.order(ByteOrder.nativeOrder());
    ...
    public class ToolsAdapter extends SelectionAdapter {
        ...
        class C45251 implements PhotoEditorSeekBarDelegate {
            C45251() {
            }
        ...
        class C45262 implements OnClickListener {
            C45262() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                photoEditToolCell.setSeekBarDelegate(new C45251());
            } else {
                photoEditToolCell = new PhotoEditRadioCell(this.mContext);
                photoEditToolCell.setOnClickListener(new C45262());
            }
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int i, SavedFilterState savedFilterState) {
        ...
        this.textureView.setSurfaceTextureListener(new C45121());
        ...
        this.blurControl.setDelegate(new C45132());
        this.curvesControl = new PhotoFilterCurvesControl(context, this.curvesToolValue);
        this.curvesControl.setDelegate(new C45143());
        ...
        this.tuneItem.setOnClickListener(new C45154());
        ...
        this.blurItem.setOnClickListener(new C45165());
        ...
        this.curveItem.setOnClickListener(new C45176());
        ...
        this.toolsView.addView(this.curveLayout, LayoutHelper.createFrame(-1, 78.0f, 1, BitmapDescriptorFactory.HUE_RED, 40.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        while (i2 < 4) {
            ...
            this.curveRadioButton[i2] = new RadioButton(context);
            ...
            String string;
            if (i2 == 0) {
                string = LocaleController.getString("CurvesAll", R.string.CurvesAll);
                ...
                string = LocaleController.getString("CurvesRed", R.string.CurvesRed);
                textView.setText(string.substring(0, 1).toUpperCase() + string.substring(1).toLowerCase());
                textView.setTextColor(-1684147);
                this.curveRadioButton[i2].setColor(-1684147, -1684147);
            } else if (i2 == 2) {
                string = LocaleController.getString("CurvesGreen", R.string.CurvesGreen);
                textView.setText(string.substring(0, 1).toUpperCase() + string.substring(1).toLowerCase());
                textView.setTextColor(-10831009);
                this.curveRadioButton[i2].setColor(-10831009, -10831009);
            } else if (i2 == 3) {
                string = LocaleController.getString("CurvesBlue", R.string.CurvesBlue);
                textView.setText(string.substring(0, 1).toUpperCase() + string.substring(1).toLowerCase());
                textView.setTextColor(-12734994);
                this.curveRadioButton[i2].setColor(-12734994, -12734994);
            }
            frameLayout2.addView(textView, LayoutHelper.createFrame(-2, -2.0f, 49, BitmapDescriptorFactory.HUE_RED, 38.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
            linearLayout2.addView(frameLayout2, LayoutHelper.createLinear(-2, -2, i2 == 0 ? BitmapDescriptorFactory.HUE_RED : 30.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
            frameLayout2.setOnClickListener(new C45187());
            i2++;
        }
        this.blurLayout = new FrameLayout(context);
        this.blurLayout.setVisibility(4);
        this.toolsView.addView(this.blurLayout, LayoutHelper.createFrame(280, 60.0f, 1, BitmapDescriptorFactory.HUE_RED, 40.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        this.blurOffButton.setOnClickListener(new C45198());
        ...
        this.blurRadialButton.setOnClickListener(new C45209());
    ...
    private void fixLayout(int i, int i2) {
        if (this.bitmapToEdit != null) {
            ...
            int dp2 = i2 - ((VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0) + AndroidUtilities.dp(214.0f));
            ...
            int ceil2 = (int) Math.ceil((double) (((float) (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) + (((float) AndroidUtilities.dp(14.0f)) + ((((float) dp2) - height) / 2.0f))));
            ...
            ((LayoutParams) this.blurControl.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + dp2;
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                if (dp3 < dp) {
                    ...
                    layoutParams.leftMargin = (dp - dp3) / 2;
                    return;
                }
    ...
    private float getTintHighlightsIntensityValue() {
        return this.tintHighlightsColor == 0 ? BitmapDescriptorFactory.HUE_RED : 50.0f / 100.0f;
    }

    private float getTintShadowsIntensityValue() {
        return this.tintShadowsColor == 0 ? BitmapDescriptorFactory.HUE_RED : 50.0f / 100.0f;
    }
    ...
    private void updateSelectedBlurType() {
        Drawable mutate;
        if (this.blurType == 0) {
            mutate = this.blurOffButton.getContext().getResources().getDrawable(R.drawable.blur_off).mutate();
            ...
            mutate = this.blurOffButton.getContext().getResources().getDrawable(R.drawable.blur_radial).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(-11420173, Mode.MULTIPLY));
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.blur_radial, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            mutate = this.blurOffButton.getContext().getResources().getDrawable(R.drawable.blur_linear).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(-11420173, Mode.MULTIPLY));
