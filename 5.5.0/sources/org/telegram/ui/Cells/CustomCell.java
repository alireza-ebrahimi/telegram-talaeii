...
public class CustomCell extends FrameLayout {
    ...
    public CustomCell(Context context, int i, int i2, boolean z) {
        float f;
        float f2;
        super(context);
        ...
        this.nameTextView.setTypeface(C2872c.b(context));
        ...
        this.statusTextView.setTypeface(C2872c.b(context));
        ...
        addView(this.ivMutual, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 3 : 5) | 16, LocaleController.isRTL ? 16.0f : 16.0f, BitmapDescriptorFactory.HUE_RED, LocaleController.isRTL ? 16.0f : 16.0f, BitmapDescriptorFactory.HUE_RED));
        if (i2 == 2) {
    ...
    public void update(int i) {
        ...
        if (this.currentObject != null) {
            ...
            if (i != 0) {
                int i4 = ((i & 2) == 0 || ((this.lastAvatar == null || fileLocation != null) && (this.lastAvatar != null || fileLocation == null || this.lastAvatar == null || fileLocation == null || (this.lastAvatar.volume_id == fileLocation.volume_id && this.lastAvatar.local_id == fileLocation.local_id)))) ? 0 : 1;
