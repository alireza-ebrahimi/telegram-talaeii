...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    class C40821 extends ActionBarMenuOnItemClick {
        C40821() {
        }
    ...
    class C40832 implements OnTouchListener {
        C40832() {
        }
    ...
    class C40853 implements OnClickListener {

        /* renamed from: org.telegram.ui.ChangePhoneHelpActivity$3$1 */
        class C40841 implements DialogInterface.OnClickListener {
            C40841() {
            }
        ...
        public void onClick(View view) {
            if (ChangePhoneHelpActivity.this.getParentActivity() != null) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C40841());
    ...
    public View createView(Context context) {
        ...
        CharSequence string = (currentUser == null || currentUser.phone == null || currentUser.phone.length() == 0) ? LocaleController.getString("NumberUnknown", R.string.NumberUnknown) : C2488b.a().e("+" + currentUser.phone);
        this.actionBar.setTitle(string);
        this.actionBar.setActionBarMenuOnItemClick(new C40821());
        this.fragmentView = new RelativeLayout(context);
        this.fragmentView.setOnTouchListener(new C40832());
        ...
        this.textView2.setOnClickListener(new C40853());
