...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[BuildConfig.VERSION_CODE] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inVenueNameText);
