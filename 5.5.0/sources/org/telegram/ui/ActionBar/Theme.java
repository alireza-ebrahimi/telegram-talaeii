...
public class Theme {
    ...
    static {
        ...
        sortThemes();
        try {
            String string2 = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).getString("theme", null);
            if (string2 != null) {
    ...
    public static void applyChatTheme(boolean z) {
        if (chat_msgTextPaint != null && chat_msgInDrawable != null && !z) {
            ...
            for (i = 0; i < 2; i++) {
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 7][0], getColor(key_chat_outLoaderPhoto), false);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 7][0], getColor(key_chat_outLoaderPhotoIcon), true);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 7][1], getColor(key_chat_outLoaderPhotoSelected), false);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 7][1], getColor(key_chat_outLoaderPhotoIconSelected), true);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 10][0], getColor(key_chat_inLoaderPhoto), false);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 10][0], getColor(key_chat_inLoaderPhotoIcon), true);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 10][1], getColor(key_chat_inLoaderPhotoSelected), false);
                setCombinedDrawableColor(chat_photoStatesDrawables[i + 10][1], getColor(key_chat_inLoaderPhotoIconSelected), true);
            }
        ...
        if (themeInfo != null) {
            ...
            try {
                ...
                if (themeInfo.pathToFile == null && themeInfo.assetName == null) {
                    ...
                    if (z) {
                        edit = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).edit();
                        edit.putString("theme", themeInfo.name);
                        if (z2) {
                            edit.remove("overrideThemeWallpaper");
                        }
                        edit.commit();
    ...
    public static void createChatResources(Context context, boolean z) {
        ...
        if (!z && chat_msgInDrawable == null) {
            ...
            try {
                ...
                paint.setShadowLayer((float) AndroidUtilities.dp(4.0f), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1593835520);
                canvas.drawCircle((float) (dp / 2), (float) (dp / 2), (float) ((AndroidUtilities.roundMessageSize / 2) - AndroidUtilities.dp(1.0f)), paint);
                try {
    ...
    public static Drawable createCircleDrawableWithIcon(int i, Drawable drawable, int i2) {
        ...
        Drawable combinedDrawable = new CombinedDrawable(shapeDrawable, drawable);
    ...
    public static Drawable createEditTextDrawable(Context context, boolean z) {
        ...
        mutate2.setColorFilter(new PorterDuffColorFilter(getColor(z ? key_dialogInputFieldActivated : key_windowBackgroundWhiteInputFieldActivated), Mode.MULTIPLY));
        Drawable theme$2 = new Theme$2();
        theme$2.addState(new int[]{16842910, 16842908}, mutate2);
        theme$2.addState(new int[]{16842908}, mutate2);
        theme$2.addState(StateSet.WILD_CARD, mutate);
        return theme$2;
    }
    ...
    public static Drawable createEmojiIconSelectorDrawable(Context context, int i, int i2, int i3) {
        ...
        Drawable theme$1 = new Theme$1();
        theme$1.setEnterFadeDuration(1);
        theme$1.setExitFadeDuration(Callback.DEFAULT_DRAG_ANIMATION_DURATION);
        theme$1.addState(new int[]{16842913}, mutate2);
        theme$1.addState(new int[0], mutate);
        return theme$1;
    }
    ...
    public static Drawable createRoundRectDrawable(int i, int i2) {
        Drawable shapeDrawable = new ShapeDrawable(new RoundRectShape(new float[]{(float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i}, null, null));
        shapeDrawable.getPaint().setColor(i2);
        return shapeDrawable;
    }
    ...
    public static Drawable createSelectorDrawable(int i, int i2) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (i2 == 1) {
                ...
                theme$4 = i2 == 2 ? new ColorDrawable(-1) : null;
            }
            return new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{i}), null, theme$4);
        }
        theme$4 = new StateListDrawable();
        theme$4.addState(new int[]{16842919}, new ColorDrawable(i));
        theme$4.addState(new int[]{16842913}, new ColorDrawable(i));
        theme$4.addState(StateSet.WILD_CARD, new ColorDrawable(0));
        return theme$4;
    }
    ...
    public static Drawable createSimpleSelectorCircleDrawable(int i, int i2, int i3) {
        ...
        Drawable shapeDrawable = new ShapeDrawable(ovalShape);
        shapeDrawable.getPaint().setColor(i2);
        Drawable shapeDrawable2 = new ShapeDrawable(ovalShape);
        if (VERSION.SDK_INT >= 21) {
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int i, int i2, int i3) {
        ...
        Drawable theme$3 = new Theme$3();
        theme$3.addState(new int[]{16842919}, mutate2);
        theme$3.addState(new int[]{16842913}, mutate2);
        theme$3.addState(StateSet.WILD_CARD, mutate);
        return theme$3;
    }
    ...
    public static Drawable createSimpleSelectorRoundRectDrawable(int i, int i2, int i3) {
        Drawable shapeDrawable = new ShapeDrawable(new RoundRectShape(new float[]{(float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i}, null, null));
        shapeDrawable.getPaint().setColor(i2);
        Drawable shapeDrawable2 = new ShapeDrawable(new RoundRectShape(new float[]{(float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i, (float) i}, null, null));
        shapeDrawable2.getPaint().setColor(i3);
        Drawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{16842919}, shapeDrawable2);
    ...
    public static File getAssetFile(String str) {
        ...
        if (!(file.exists() && (r0 == 0 || file.length() == r0))) {
    ...
    private static Drawable getStateDrawable(Drawable drawable, int i) {
        ...
        try {
            return (Drawable) StateListDrawable_getStateDrawableMethod.invoke(drawable, new Object[]{Integer.valueOf(i)});
        } catch (Exception e) {
            return null;
        }
    }
            ...
            try {
                ...
                while (true) {
                    ...
                    for (int i4 = 0; i4 < read; i4++) {
                        if (bArr[i4] == (byte) 10) {
                            int i5 = (i4 - i2) + 1;
                            String str2 = new String(bArr, i2, i5 - 1, C3446C.UTF8_NAME);
                            if (str2.startsWith("WPS")) {
                                themedWallpaperFileOffset = i3 + i5;
                                obj2 = 1;
                                break;
                            }
                    ...
                    obj2 = obj;
                    if (i != i3) {
                        fileInputStream2.getChannel().position((long) i3);
                        if (obj2 != null) {
                            break;
                        }
                        obj = obj2;
            ...
            try {
                ...
                try {
                    ...
                    if (decodeStream != null) {
                        Drawable bitmapDrawable = new BitmapDrawable(decodeStream);
        ...
        try {
            ...
            try {
                ...
                if (themedWallpaper instanceof BitmapDrawable) {
                    ...
                    if (bitmap != null) {
                        fileOutputStream.write(new byte[]{(byte) 87, (byte) 80, (byte) 83, (byte) 10});
                        bitmap.compress(CompressFormat.JPEG, 87, fileOutputStream);
                        fileOutputStream.write(new byte[]{(byte) 10, (byte) 87, (byte) 80, (byte) 69, (byte) 10});
                    }
                    if (z) {
    ...
    public static void setCombinedDrawableColor(Drawable drawable, int i, boolean z) {
        if (drawable instanceof CombinedDrawable) {
            (z ? ((CombinedDrawable) drawable).getIcon() : ((CombinedDrawable) drawable).getBackground()).setColorFilter(new PorterDuffColorFilter(i, Mode.MULTIPLY));
        }
    }
    ...
    public static void setDrawableColorByKey(Drawable drawable, String str) {
        drawable.setColorFilter(new PorterDuffColorFilter(getColor(str), Mode.MULTIPLY));
    }
    ...
    public static void setSelectorDrawableColor(Drawable drawable, int i, boolean z) {
        ...
        if (drawable instanceof StateListDrawable) {
            ...
            if (z) {
                ...
                stateDrawable = rippleDrawable.getDrawable(0);
                if (stateDrawable instanceof ShapeDrawable) {
                    ((ShapeDrawable) stateDrawable).getPaint().setColor(i);
                } else {
                    stateDrawable.setColorFilter(new PorterDuffColorFilter(i, Mode.MULTIPLY));
