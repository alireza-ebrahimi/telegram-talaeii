...
public class C3773e extends LinearLayout implements C0188f, ImageGetter, OnClickListener, C1651a, C2497d, C3733c {
    ...
    class C37687 implements Runnable {
        ...
        L_0x0107:
            ...
            r2 = utils.C3792d.m14081a(r2);	 Catch:{ Exception -> 0x02b8 }
    ...
    public static void m13863a(Activity activity, int i) {
        if (VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(C3792d.m14076a(i, 0.8f));
        }
    }
    ...
    private void m13869b(final C3744b c3744b) {
        ...
        LayoutParams layoutParams = new LinearLayout.LayoutParams(0, C3792d.m14075a((float) (C3792d.m14077a(getContext()) / 5), getContext()));
    ...
    private void m13878f() {
        if (this.f10129y == BitmapDescriptorFactory.HUE_RED) {
            this.f10129y = C3791b.m14041s(this.f10120p);
        }
    ...
    public void mo4197a(int i, boolean z, boolean z2) {
        ...
        if (this.ai) {
            height = Math.abs(this.af.getChildAt(0).getHeight() - C3792d.m14086b(this.f10120p));
            if (height == 0) {
                height = 1;
            }
