...
public class RecyclerView extends ViewGroup implements ad, C0078v {
    ...
    static final Interpolator sQuinticInterpolator = new C36743();
    ...
    private C0661w mScrollingChildHelper;
    final State mState;
    final Rect mTempRect;
    private final Rect mTempRect2;
    final RectF mTempRectF;
    private C0700i mTopGlow;
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C36781();
        ...
        private final Callback mVerticalBoundCheckCallback = new C36792();
        private int mWidth;
        ...
        class C36781 implements Callback {
            C36781() {
            }
        ...
        class C36792 implements Callback {
            C36792() {
            }
        ...
        public int getLayoutDirection() {
            return ah.m2812g(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return ah.m2826p(this.mRecyclerView);
        }

        public int getMinimumWidth() {
            return ah.m2825o(this.mRecyclerView);
        }
        ...
        public int getPaddingEnd() {
            return this.mRecyclerView != null ? ah.m2820k(this.mRecyclerView) : 0;
        }
        ...
        public int getPaddingStart() {
            return this.mRecyclerView != null ? ah.m2818j(this.mRecyclerView) : 0;
        }
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state, AccessibilityEvent accessibilityEvent) {
            ...
            if (this.mRecyclerView != null && a != null) {
                if (!(ah.m2798b(this.mRecyclerView, 1) || ah.m2798b(this.mRecyclerView, -1) || ah.m2792a(this.mRecyclerView, -1) || ah.m2792a(this.mRecyclerView, 1))) {
                    z = false;
                }
                a.m2485d(z);
                if (this.mRecyclerView.mAdapter != null) {
                    a.m2475a(this.mRecyclerView.mAdapter.getItemCount());
                }
            }
        }

        void onInitializeAccessibilityNodeInfo(C0531e c0531e) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, c0531e);
        }

        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, C0531e c0531e) {
            if (ah.m2798b(this.mRecyclerView, -1) || ah.m2792a(this.mRecyclerView, -1)) {
            ...
            c0531e.m2314b(C0529l.m2297a(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }

        void onInitializeAccessibilityNodeInfoForItem(View view, C0531e c0531e) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, c0531e);
            }
        }

        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0531e c0531e) {
            c0531e.m2321c(C0530m.m2298a(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false, false));
        }
        ...
        public boolean performAccessibilityAction(org.telegram.messenger.support.widget.RecyclerView.Recycler r7, org.telegram.messenger.support.widget.RecyclerView.State r8, int r9, android.os.Bundle r10) {
            /*
            r6 = this;
            r4 = -1;
            r2 = 1;
        ...
        public void postOnAnimation(Runnable runnable) {
            if (this.mRecyclerView != null) {
                ah.m2787a(this.mRecyclerView, runnable);
            }
        }
    ...
    class C36721 implements Runnable {
        C36721() {
        }
    ...
    class C36732 implements Runnable {
        C36732() {
        }
    ...
    static class C36743 implements Interpolator {
        C36743() {
        }
    ...
    class C36754 implements ProcessCallback {
        C36754() {
        }
    ...
    class C36765 implements Callback {
        C36765() {
        }
    ...
    class C36776 implements Callback {
        C36776() {
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            C0440j.m1922a(RecyclerView.TRACE_BIND_VIEW_TAG);
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            C0440j.m1922a(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegate(View view) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!ah.m2791a(view)) {
                    ah.m2783a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
        ...
        void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z) {
            ...
            ah.m2783a(viewHolder.itemView, null);
            if (z) {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (z4 && !RecyclerView.this.mState.isPreLayout() && changedScrapViewForPosition.hasAnyOfTheFlags(MessagesController.UPDATE_MASK_CHANNEL)) {
                changedScrapViewForPosition.setFlags(0, MessagesController.UPDATE_MASK_CHANNEL);
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                ah.m2787a(RecyclerView.this, RecyclerView.this.mUpdateChildViewsRunnable);
                return;
            }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = C0437f.m1919a(new C36801());
        Parcelable mLayoutState;

        /* renamed from: org.telegram.messenger.support.widget.RecyclerView$SavedState$1 */
        static class C36801 implements C0085g<SavedState> {
            C36801() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        private C0729x mScroller;

        public ViewFlinger() {
            this.mScroller = C0729x.m3542a(RecyclerView.this.getContext(), RecyclerView.sQuinticInterpolator);
        }
        ...
        public void fling(int i, int i2) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.m3545a(0, 0, i, i2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        void postOnAnimation() {
            ...
            ah.m2787a(RecyclerView.this, (Runnable) this);
        }
        ...
        public void run() {
            ...
            if (c0729x.m3554g()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    C0440j.m1922a(RecyclerView.TRACE_SCROLL_TAG);
                    if (i3 != 0) {
        ...
        public void smoothScrollBy(int i, int i2, int i3, Interpolator interpolator) {
            if (this.mInterpolator != interpolator) {
                this.mInterpolator = interpolator;
                this.mScroller = C0729x.m3542a(RecyclerView.this.getContext(), interpolator);
            }
            RecyclerView.this.setScrollState(2);
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.m3544a(0, 0, i, i2, i3);
            postOnAnimation();
        }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C36721();
        ...
        this.mItemAnimatorRunner = new C36732();
        this.mViewInfoProcessCallback = new C36754();
    ...
    private C0661w getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new C0661w(this);
        }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C36765());
    }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        return isPreferredNextFocusAbsolute(view, view2, (i2 ^ i3) != 0 ? 66 : 17) ? true : i == 2 ? isPreferredNextFocusAbsolute(view, view2, TsExtractor.TS_STREAM_TYPE_HDMV_DTS) : isPreferredNextFocusAbsolute(view, view2, 33);
    }
    ...
    private void releaseGlows() {
        ...
        if (this.mLeftGlow != null) {
            i = this.mLeftGlow.m3426c();
        }
        if (this.mTopGlow != null) {
            i |= this.mTopGlow.m3426c();
        }
        if (this.mRightGlow != null) {
            i |= this.mRightGlow.m3426c();
        }
        if (this.mBottomGlow != null) {
            i |= this.mBottomGlow.m3426c();
        }
        if (i != 0) {
            ah.m2799c(this);
        }
    ...
    void absorbGlows(int i, int i2) {
        if (i < 0) {
            ensureLeftGlow();
            this.mLeftGlow.m3423a(-i);
        } else if (i > 0) {
            ensureRightGlow();
            this.mRightGlow.m3423a(i);
        }
        if (i2 < 0) {
            ensureTopGlow();
            this.mTopGlow.m3423a(-i2);
        } else if (i2 > 0) {
            ensureBottomGlow();
            this.mBottomGlow.m3423a(i2);
        }
        if (i != 0 || i2 != 0) {
            ah.m2799c(this);
        }
    ...
    void applyEdgeEffectColor(C0700i c0700i) {
        if (VERSION.SDK_INT >= 21 && this.glowColor != 0) {
            try {
                Field declaredField = C0700i.class.getDeclaredField("a");
                declaredField.setAccessible(true);
                EdgeEffect edgeEffect = (EdgeEffect) declaredField.get(c0700i);
                if (edgeEffect != null) {
    ...
    void considerReleasingGlowsOnScroll(int i, int i2) {
        int i3 = 0;
        if (!(this.mLeftGlow == null || this.mLeftGlow.m3420a() || i <= 0)) {
            i3 = this.mLeftGlow.m3426c();
        }
        if (!(this.mRightGlow == null || this.mRightGlow.m3420a() || i >= 0)) {
            i3 |= this.mRightGlow.m3426c();
        }
        if (!(this.mTopGlow == null || this.mTopGlow.m3420a() || i2 <= 0)) {
            i3 |= this.mTopGlow.m3426c();
        }
        if (!(this.mBottomGlow == null || this.mBottomGlow.m3420a() || i2 >= 0)) {
            i3 |= this.mBottomGlow.m3426c();
        }
        if (i3 != 0) {
            ah.m2799c(this);
        }
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            C0440j.m1922a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
            C0440j.m1921a();
        } else if (!this.mAdapterHelper.hasPendingUpdates()) {
        } else {
            if (this.mAdapterHelper.hasAnyUpdateTypes(4) && !this.mAdapterHelper.hasAnyUpdateTypes(11)) {
                C0440j.m1922a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                eatRequestLayout();
                onEnterLayoutOrScroll();
                this.mAdapterHelper.preProcess();
    ...
    void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), ah.m2825o(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), ah.m2826p(this)));
    }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore()) {
                ...
                if (i != -1) {
                    ah.m2801c(viewHolder.itemView, i);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mLeftGlow == null || this.mLeftGlow.m3420a()) {
            i2 = 0;
        } else {
            i = canvas.save();
            ...
            i2 = (this.mLeftGlow == null || !this.mLeftGlow.m3424a(canvas)) ? 0 : 1;
            canvas.restoreToCount(i);
        }
        if (!(this.mTopGlow == null || this.mTopGlow.m3420a())) {
            size = canvas.save();
            if (this.mClipToPadding) {
                canvas.translate((float) getPaddingLeft(), (float) getPaddingTop());
            }
            canvas.translate(BitmapDescriptorFactory.HUE_RED, (float) this.topGlowOffset);
            i = (this.mTopGlow == null || !this.mTopGlow.m3424a(canvas)) ? 0 : 1;
            i2 |= i;
            canvas.restoreToCount(size);
        }
        if (!(this.mRightGlow == null || this.mRightGlow.m3420a())) {
            size = canvas.save();
            int width = getWidth();
            i = this.mClipToPadding ? getPaddingTop() : 0;
            canvas.rotate(90.0f);
            canvas.translate((float) (-i), (float) (-width));
            i = (this.mRightGlow == null || !this.mRightGlow.m3424a(canvas)) ? 0 : 1;
            i2 |= i;
            canvas.restoreToCount(size);
        }
        if (!(this.mBottomGlow == null || this.mBottomGlow.m3420a())) {
            i = canvas.save();
            ...
            if (this.mBottomGlow != null && this.mBottomGlow.m3424a(canvas)) {
                i4 = 1;
            }
            i2 |= i4;
            canvas.restoreToCount(i);
    ...
    void ensureBottomGlow() {
        if (this.mBottomGlow == null) {
            this.mBottomGlow = new C0700i(getContext());
            if (this.mClipToPadding) {
                this.mBottomGlow.m3419a((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), (getMeasuredHeight() - getPaddingTop()) - getPaddingBottom());
            } else {
                this.mBottomGlow.m3419a(getMeasuredWidth(), getMeasuredHeight());
            }
    ...
    void ensureLeftGlow() {
        if (this.mLeftGlow == null) {
            this.mLeftGlow = new C0700i(getContext());
            if (this.mClipToPadding) {
                this.mLeftGlow.m3419a((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight());
            } else {
                this.mLeftGlow.m3419a(getMeasuredHeight(), getMeasuredWidth());
            }
    ...
    void ensureRightGlow() {
        if (this.mRightGlow == null) {
            this.mRightGlow = new C0700i(getContext());
            if (this.mClipToPadding) {
                this.mRightGlow.m3419a((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight());
            } else {
                this.mRightGlow.m3419a(getMeasuredHeight(), getMeasuredWidth());
            }
    ...
    void ensureTopGlow() {
        if (this.mTopGlow == null) {
            this.mTopGlow = new C0700i(getContext());
            if (this.mClipToPadding) {
                this.mTopGlow.m3419a((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), (getMeasuredHeight() - getPaddingTop()) - getPaddingBottom());
            } else {
                this.mTopGlow.m3419a(getMeasuredWidth(), getMeasuredHeight());
            }
    ...
    public View findChildViewUnder(float f, float f2) {
        for (int childCount = this.mChildHelper.getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            float l = ah.m2822l(childAt);
            float m = ah.m2823m(childAt);
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C36776());
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        if (!(this.mLayout == null || this.mLayoutFrozen || (motionEvent.getSource() & 2) == 0 || motionEvent.getAction() != 8)) {
            float f = this.mLayout.canScrollVertically() ? -C0659t.m3204a(motionEvent, 9) : BitmapDescriptorFactory.HUE_RED;
            float a = this.mLayout.canScrollHorizontally() ? C0659t.m3204a(motionEvent, 10) : BitmapDescriptorFactory.HUE_RED;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        C0440j.m1922a(TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        C0440j.m1921a();
        ...
        if (dispatchOnItemTouch(motionEvent)) {
            ...
            switch (a) {
                ...
                case 1:
                    ...
                    float f = canScrollHorizontally ? -af.m2516a(this.mVelocityTracker, this.mScrollPointerId) : BitmapDescriptorFactory.HUE_RED;
                    float f2 = canScrollVertically ? -af.m2517b(this.mVelocityTracker, this.mScrollPointerId) : BitmapDescriptorFactory.HUE_RED;
                ...
                case 2:
                    ...
                    if (a >= 0) {
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (scrollByInternal(canScrollHorizontally ? i : 0, canScrollVertically ? a : 0, obtain)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                            }
    ...
    void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            ah.m2787a((View) this, this.mItemAnimatorRunner);
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            ...
            eatRequestLayout();
            onEnterLayoutOrScroll();
            C0440j.m1922a(TRACE_SCROLL_TAG);
            if (i != 0) {
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        ah.m2783a((View) this, this.mAccessibilityDelegate);
    }
