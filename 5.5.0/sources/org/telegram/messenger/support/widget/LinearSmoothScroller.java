...
public class LinearSmoothScroller extends SmoothScroller {
    ...
    protected int getHorizontalSnapPreference() {
        return (this.mTargetVector == null || this.mTargetVector.x == BitmapDescriptorFactory.HUE_RED) ? 0 : this.mTargetVector.x > BitmapDescriptorFactory.HUE_RED ? 1 : -1;
    }

    protected int getVerticalSnapPreference() {
        return (this.mTargetVector == null || this.mTargetVector.y == BitmapDescriptorFactory.HUE_RED) ? 0 : this.mTargetVector.y > BitmapDescriptorFactory.HUE_RED ? 1 : -1;
    }
