...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C36841();
    ...
    class C36841 implements Runnable {
        C36841() {
        }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C36851();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C36851 implements Creator<FullSpanItem> {
                C36851() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C36861();
        ...
        static class C36861 implements Creator<SavedState> {
            C36861() {
            }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0531e c0531e) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                c0531e.m2321c(C0530m.m2298a(layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, -1, -1, layoutParams2.mFullSpan, false));
                return;
            } else {
                c0531e.m2321c(C0530m.m2298a(-1, -1, layoutParams2.getSpanIndex(), layoutParams2.mFullSpan ? this.mSpanCount : 1, layoutParams2.mFullSpan, false));
                return;
            }
        }
        super.onInitializeAccessibilityNodeInfoForItem(view, c0531e);
    }
