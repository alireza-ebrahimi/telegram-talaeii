...
public class GridLayoutManager extends LinearLayoutManager {
        ...
        while (i != i2) {
            ...
            if (position >= 0 && position < i3) {
                if (getSpanIndex(recycler, state, position) != 0) {
                    view3 = view;
                    childAt = view2;
                } else if (((org.telegram.messenger.support.widget.RecyclerView.LayoutParams) childAt.getLayoutParams()).isItemRemoved()) {
                    if (view2 == null) {
                        view3 = view;
                    }
    ...
    protected int getSpanIndex(Recycler recycler, State state, int i) {
        if (!state.isPreLayout()) {
    ...
    protected void guessMeasurement(float f, int i) {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0531e c0531e) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                c0531e.m2321c(C0530m.m2298a(spanIndex, spanSize, spanGroupIndex, 1, z, false));
                return;
            }
            int spanIndex2 = layoutParams2.getSpanIndex();
            int spanSize2 = layoutParams2.getSpanSize();
            boolean z2 = this.mSpanCount > 1 && layoutParams2.getSpanSize() == this.mSpanCount;
            c0531e.m2321c(C0530m.m2298a(spanGroupIndex, 1, spanIndex2, spanSize2, z2, false));
            return;
        }
