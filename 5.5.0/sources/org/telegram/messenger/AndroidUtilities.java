    ...
    public static void installShortcut(long j) {
        ...
        if (user != null || chat != null) {
            ...
            if (user == null) {
                ...
                obj2 = LocaleController.getString("SavedMessages", R.string.SavedMessages);
                obj = 1;
                tLObject = null;
            } else {
                obj2 = ContactsController.formatName(user.first_name, user.last_name);
                if (user.photo != null) {
                    tLObject = user.photo.photo_small;
                }
                tLObject = null;
            }
            if (!(obj == null && tLObject == null)) {
                if (obj == null) {
                    try {
                        ...
                        try {
                            ...
                            if (VERSION.SDK_INT >= 26) {
                                intent = new Builder(ApplicationLoader.applicationContext, "sdid_" + j).setShortLabel(obj2).setIntent(createIntrnalShortcutIntent);
                                if (parcelable == null) {
