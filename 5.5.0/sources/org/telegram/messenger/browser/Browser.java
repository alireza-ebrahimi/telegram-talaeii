                ...
                if (z && MediaController.getInstance().canCustomTabs() && !isInternalUri && !toLowerCase.equals("tel")) {
                    ...
                    try {
                        ...
                        if (queryIntentActivities2 == null || queryIntentActivities2.isEmpty()) {
                            ...
                            strArr = new String[queryIntentActivities2.size()];
                            int i3 = 0;
                            while (i3 < queryIntentActivities2.size()) {
                                try {
                                    strArr[i3] = ((ResolveInfo) queryIntentActivities2.get(i3)).activityInfo.packageName;
                                    FileLog.m13725d("default browser name = " + strArr[i3]);
                                    i3++;
                                } catch (Exception e2) {
                                    strArr2 = strArr;
                                }
                                ...
                                while (i < queryIntentActivities.size()) {
                                    try {
                                        for (String equals : strArr) {
                                            if (equals.equals(((ResolveInfo) queryIntentActivities.get(i)).activityInfo.packageName)) {
