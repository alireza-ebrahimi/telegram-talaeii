...
public class MessagesController implements NotificationCenterDelegate {
            ...
            public void run() {
                ...
                if (i4 == 1 || i3 == 0 || !z5 || tLRPC$messages_Messages2.messages.size() != 0) {
                    ...
                    try {
                        ...
                        if (!z3 && C3791b.m13993h(ApplicationLoader.applicationContext)) {
                            try {
    ...
    public boolean processUpdateArray(ArrayList<TLRPC$Update> arrayList, ArrayList<User> arrayList2, ArrayList<Chat> arrayList3, boolean z) {
        ...
        while (i4 < arrayList.size()) {
            boolean z3;
            Integer num;
            TLRPC$Update tLRPC$Update = (TLRPC$Update) arrayList.get(i4);
            ...
            if ((tLRPC$Update instanceof TLRPC$TL_updateNewMessage) || (tLRPC$Update instanceof TLRPC$TL_updateNewChannelMessage)) {
                ...
                if (obj3 == null) {
                    ...
                    while (i7 < size) {
                        ...
                        if (i7 == 0) {
                            ...
                            i3 = messageEntity instanceof TLRPC$TL_messageEntityMentionName ? ((TLRPC$TL_messageEntityMentionName) messageEntity).user_id : 0;
                        }
                        if (i3 > 0) {
                            user = (User) abstractMap.get(Integer.valueOf(i3));
                            if (user == null || (r7 == null && user.min)) {
                                user = getUser(Integer.valueOf(i3));
                            }
                            if (user == null || (r7 == null && user.min)) {
                                user = MessagesStorage.getInstance().getUserSync(i3);
                                if (user != null && r7 == null && user.min) {
                                    user = null;
                                }
                                putUser(user, true);
                            ...
                            if (user == null) {
                                FileLog.m13725d("not found user " + i3);
                                return false;
                            } else if (i7 == 1 && user.status != null && user.status.expires <= 0) {
                                this.onlinePrivacy.put(Integer.valueOf(i3), Integer.valueOf(ConnectionsManager.getInstance().getCurrentTime()));
                                i8 = i2 | 4;
                                i7++;
                                i2 = i8;
                                i8 = i3;
                ...
                i3 = UserConfig.getClientUserId();
                if (message.to_id.chat_id != 0) {
                    message.dialog_id = (long) (-message.to_id.chat_id);
                } else if (message.to_id.channel_id != 0) {
                    message.dialog_id = (long) (-message.to_id.channel_id);
                } else {
                    if (message.to_id.user_id == i3) {
                        message.to_id.user_id = message.from_id;
                    }
                    message.dialog_id = (long) message.to_id.user_id;
                }
                ...
                arrayList6 = (ArrayList) hashMap.get(Long.valueOf(message.dialog_id));
                if (arrayList6 == null) {
                    arrayList6 = new ArrayList();
                    hashMap.put(Long.valueOf(message.dialog_id), arrayList6);
                }
                ...
                for (i = 0; i < tLRPC$Update.messages.size(); i++) {
                    arrayList9.add(Long.valueOf((long) ((Integer) tLRPC$Update.messages.get(i)).intValue()));
                }
                i = i5;
                z3 = z2;
            } else if (tLRPC$Update instanceof TLRPC$TL_updateChannelReadMessagesContents) {
                for (i = 0; i < tLRPC$Update.messages.size(); i++) {
                    arrayList9.add(Long.valueOf(((long) ((Integer) tLRPC$Update.messages.get(i)).intValue()) | (((long) tLRPC$Update.channel_id) << 32)));
                }
                i = i5;
                z3 = z2;
                ...
                arrayList6 = (ArrayList) sparseArray4.get(0);
                if (arrayList6 == null) {
                    arrayList6 = new ArrayList();
                    sparseArray4.put(0, arrayList6);
                }
                arrayList6.addAll(tLRPC$Update.messages);
                i = i5;
                z3 = z2;
            } else {
                ...
                if ((tLRPC$Update instanceof TLRPC$TL_updateUserTyping) || (tLRPC$Update instanceof TLRPC$TL_updateChatUserTyping)) {
                    if (tLRPC$Update.user_id != UserConfig.getClientUserId()) {
                        ...
                        arrayList6 = (ArrayList) this.printingUsers.get(Long.valueOf(r6));
                        if (!(tLRPC$Update.action instanceof TLRPC$TL_sendMessageCancelAction)) {
                            if (arrayList6 == null) {
                                arrayList6 = new ArrayList();
                                this.printingUsers.put(Long.valueOf(r6), arrayList6);
                            ...
                            for (i3 = 0; i3 < arrayList6.size(); i3++) {
                                if (((PrintingUser) arrayList6.get(i3)).userId == tLRPC$Update.user_id) {
                    ...
                    i5 |= 32;
                    arrayList10.add(tLRPC$Update.participants);
                    i = i5;
                    z3 = z2;
                    ...
                    if (tLRPC$Update.my_link instanceof TLRPC$TL_contactLinkContact) {
                        i8 = arrayList13.indexOf(Integer.valueOf(-tLRPC$Update.user_id));
                        if (i8 != -1) {
                            arrayList13.remove(i8);
                        }
                        if (!arrayList13.contains(Integer.valueOf(tLRPC$Update.user_id))) {
                            arrayList13.add(Integer.valueOf(tLRPC$Update.user_id));
                        }
                        i = i5;
                        z3 = z2;
                    } else {
                    ...
                    if (!(decryptMessage == null || decryptMessage.isEmpty())) {
                        ...
                        arrayList6 = (ArrayList) hashMap.get(Long.valueOf(r8));
                        if (arrayList6 == null) {
                            arrayList6 = new ArrayList();
                            hashMap.put(Long.valueOf(r8), arrayList6);
                            arrayList14 = arrayList6;
                        } else {
                            arrayList14 = arrayList6;
                        }
                    ...
                    arrayList12.add((TLRPC$TL_updateEncryptedMessagesRead) tLRPC$Update);
                    i = i5;
                    z3 = z2;
                    ...
                    if (tLRPC$TL_updateUserBlocked.blocked) {
                        arrayList6 = new ArrayList();
                        arrayList6.add(Integer.valueOf(tLRPC$TL_updateUserBlocked.user_id));
                        MessagesStorage.getInstance().putBlockedUsers(arrayList6, false);
                    } else {
                    ...
                    arrayList6 = (ArrayList) sparseArray4.get(tLRPC$Update.channel_id);
                    if (arrayList6 == null) {
                        arrayList6 = new ArrayList();
                        sparseArray4.put(tLRPC$Update.channel_id, arrayList6);
                    }
                    arrayList6.addAll(tLRPC$Update.messages);
                    i = i5;
                    z3 = z2;
                    ...
                    ImageLoader.saveMessageThumbs(message);
                    r6 = new MessageObject(message, abstractMap, abstractMap2, this.createdDialogIds.contains(Long.valueOf(message.dialog_id)));
                    arrayList6 = (ArrayList) hashMap3.get(Long.valueOf(message.dialog_id));
                    if (arrayList6 == null) {
                        arrayList6 = new ArrayList();
                        hashMap3.put(Long.valueOf(message.dialog_id), arrayList6);
                    }
                    arrayList6.add(r6);
                    i = i5;
                    z3 = z2;
        ...
        if (!arrayList13.isEmpty()) {
            ContactsController.getInstance().processContactsUpdates(arrayList13, abstractMap);
        }
        ...
        if (!arrayList8.isEmpty()) {
            StatsController.getInstance().incrementReceivedItemsCount(ConnectionsManager.getCurrentNetworkType(), 1, arrayList8.size());
        ...
        if (!hashMap3.isEmpty()) {
            for (Entry entry2 : hashMap3.entrySet()) {
                ...
                arrayList6 = (ArrayList) entry2.getValue();
                for (i3 = 0; i3 < arrayList6.size(); i3++) {
                    tLRPC$TL_messages_messages.messages.add(((MessageObject) arrayList6.get(i3)).messageOwner);
                }
        ...
        if (!(sparseArray2.size() == 0 && sparseArray3.size() == 0 && hashMap4.isEmpty() && arrayList9.isEmpty())) {
            if (!(sparseArray2.size() == 0 && arrayList9.isEmpty())) {
                MessagesStorage.getInstance().updateDialogsWithReadMessages(sparseArray2, sparseArray3, arrayList9, true);
            }
            MessagesStorage.getInstance().markMessagesAsRead(sparseArray2, sparseArray3, hashMap4, true);
        }
        if (!arrayList9.isEmpty()) {
            MessagesStorage.getInstance().markMessagesContentAsRead(arrayList9, ConnectionsManager.getInstance().getCurrentTime());
        }
        if (sparseArray4.size() != 0) {
            for (i = 0; i < sparseArray4.size(); i++) {
                i2 = sparseArray4.keyAt(i);
                arrayList6 = (ArrayList) sparseArray4.get(i2);
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                    public void run() {
                        MessagesStorage.getInstance().updateDialogsWithDeletedMessages(arrayList6, MessagesStorage.getInstance().markMessagesAsDeleted(arrayList6, false, i2), false, i2);
                    }
                });
            }
        }
        ...
        if (!arrayList12.isEmpty()) {
            for (int i9 = 0; i9 < arrayList12.size(); i9++) {
                TLRPC$TL_updateEncryptedMessagesRead tLRPC$TL_updateEncryptedMessagesRead = (TLRPC$TL_updateEncryptedMessagesRead) arrayList12.get(i9);
    ...
    public void sortDialogs(HashMap<Integer, Chat> hashMap) {
        ...
        boolean x = C3791b.m14060x(ApplicationLoader.applicationContext);
    ...
    public void updateDialogsForAddOrRemoveDialog() {
        ...
        for (int i = 0; i < this.dialogs.size(); i++) {
            ...
            if (this.hiddensIds.contains(Long.valueOf(tLRPC$TL_dialog.id))) {
                if (C3791b.m14060x(ApplicationLoader.applicationContext)) {
                    this.dialogsHidden.add(tLRPC$TL_dialog);
                } else {
                }
            }
            ...
            if (C3791b.m14060x(ApplicationLoader.applicationContext) || !this.hiddensIds.contains(Long.valueOf(tLRPC$TL_dialog.id))) {
                this.dialogsAll.add(tLRPC$TL_dialog);
            }
            int i2 = (int) (tLRPC$TL_dialog.id >> 32);
