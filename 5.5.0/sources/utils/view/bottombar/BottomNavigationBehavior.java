...
class BottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    /* renamed from: a */
    private void m14332a(V v, int i) {
        if (!this.f10449i) {
            return;
        }
        if (i == -1 && this.f10446f) {
            this.f10446f = false;
            m14336b(v, this.f10443c);
        } else if (i == 1 && !this.f10446f) {
            this.f10446f = true;
            m14336b(v, this.f10442b + this.f10443c);
        }
    }

    /* renamed from: a */
    private void m14333a(View view, boolean z) {
    ...
    /* renamed from: b */
    private void m14336b(V v, int i) {
        m14331a((View) v);
    ...
    /* renamed from: b */
    public boolean m14342b(CoordinatorLayout coordinatorLayout, V v, View view) {
        this.f10448h.mo4649a(coordinatorLayout, view, v);
        return view instanceof SnackbarLayout;
    }

    /* renamed from: c */
    public boolean m14343c(CoordinatorLayout coordinatorLayout, V v, View view) {
        m14333a(view, false);
        return super.c(coordinatorLayout, v, view);
    }

    /* renamed from: d */
    public void m14344d(CoordinatorLayout coordinatorLayout, V v, View view) {
        m14333a(view, true);
