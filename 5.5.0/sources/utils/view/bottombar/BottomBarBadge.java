...
class BottomBarBadge extends TextView {
    ...
    /* renamed from: a */
    private void m14262a(Drawable drawable) {
    ...
    /* renamed from: c */
    private void m14263c(final BottomBarTab bottomBarTab) {
        ...
        badgeContainer.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener(this) {
            ...
            public void onGlobalLayout() {
                ...
                this.f10388c.m14270b(bottomBarTab);
            }
        });
    }
    ...
    /* renamed from: a */
    void m14266a(BottomBarTab bottomBarTab) {
    ...
    /* renamed from: a */
    void m14267a(BottomBarTab bottomBarTab, int i) {
        setLayoutParams(new LayoutParams(-2, -2));
        setGravity(17);
        MiscUtils.m14348a((TextView) this, (int) R.style.BB_BottomBarBadge_Text);
        m14269b(i);
        m14263c(bottomBarTab);
    }
    ...
    /* renamed from: b */
    void m14269b(int i) {
        int a = MiscUtils.m14346a(getContext(), 1.0f);
        Drawable a2 = BadgeCircle.m14207a(a * 3, i);
        setPadding(a, a, a, a);
        m14262a(a2);
    }

    /* renamed from: b */
    void m14270b(BottomBarTab bottomBarTab) {
