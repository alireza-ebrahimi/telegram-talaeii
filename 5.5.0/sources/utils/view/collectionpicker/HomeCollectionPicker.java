...
public class HomeCollectionPicker extends LinearLayout {
    ...
    public HomeCollectionPicker(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f10509h = (int) obtainStyledAttributes.getDimension(5, (float) Utils.m14396a(getContext(), this.f10509h));
        this.f10510i = (int) obtainStyledAttributes.getDimension(7, (float) Utils.m14396a(getContext(), this.f10510i));
        this.f10511j = (int) obtainStyledAttributes.getDimension(8, (float) Utils.m14396a(getContext(), this.f10511j));
        this.f10512k = (int) obtainStyledAttributes.getDimension(9, (float) Utils.m14396a(getContext(), this.f10512k));
        this.f10513l = (int) obtainStyledAttributes.getDimension(10, (float) Utils.m14396a(getContext(), this.f10513l));
    ...
    /* renamed from: a */
    private View m14379a(Item item) {
        return this.f10503b.inflate(this.f10522u, this, false);
    }

    /* renamed from: a */
    private void m14380a(final View view) {
        view.setScaleY(1.0f);
        view.setScaleX(1.0f);
    ...
    /* renamed from: a */
    private void m14381a(View view, int i) {
    ...
    /* renamed from: a */
    private void m14382a(View view, LayoutParams layoutParams, boolean z, int i) {
    ...
    /* renamed from: b */
    private void m14387b(View view) {
        view.setScaleY(1.2f);
        view.setScaleX(1.2f);
        ...
        if (this.f10520s) {
            ...
            while (z < this.f10504c.size()) {
                ...
                if (((float) this.f10508g) <= f) {
                    ...
                    m14382a(a, itemLayoutParams, true, z);
                    z3 = z;
                } else {
                    if (z != z2) {
                    ...
                    m14382a(a, itemLayoutParams, false, z);
                    z3 = z2;
                }
                z++;
                f += paddingLeft;
    ...
    /* renamed from: a */
    public void m14392a(List<Item> list) {
        if (this.f10520s) {
            float paddingLeft = (float) (getPaddingLeft() + getPaddingRight());
            LayoutParams itemLayoutParams = getItemLayoutParams();
            boolean z = false;
            ...
            while (z < list.size()) {
                ...
                textView.setText(item.f10524b);
                textView.setPadding(this.f10510i, this.f10512k, this.f10511j, this.f10513l);
                paddingLeft = ((textView.getPaint().measureText(item.f10524b) + ((float) this.f10510i)) + ((float) this.f10511j)) + ((float) ((Utils.m14396a(getContext(), 45) + this.f10510i) + this.f10511j));
                this.f10521t = false;
                if (((float) this.f10508g) <= (f + paddingLeft) + ((float) Utils.m14396a(getContext(), 3))) {
                    f = (float) (getPaddingLeft() + getPaddingRight());
                    m14382a(a, itemLayoutParams, true, z);
                    z3 = z;
                } else {
            ...
            this.f10521t = false;
            m14382a(null, itemLayoutParams, true, list.size());
        }
    }
