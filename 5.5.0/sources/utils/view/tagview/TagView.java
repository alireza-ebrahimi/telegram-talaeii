...
public class TagView extends RelativeLayout {
    ...
    public interface OnTagClickListener {
        /* renamed from: a */
        void m14397a(TagViewModel tagViewModel, int i);
    }

    public interface OnTagDeleteListener {
        /* renamed from: a */
        void m14398a(TagView tagView, TagViewModel tagViewModel, int i);
    }

    /* renamed from: a */
    private Drawable m14399a(TagViewModel tagViewModel) {
        ...
        if (this.f10544f) {
            ...
            for (final TagViewModel tagViewModel2 : this.f10539a) {
                ...
                if (VERSION.SDK_INT < 16) {
                    inflate.setBackgroundDrawable(m14399a(tagViewModel2));
                } else {
                    inflate.setBackground(m14399a(tagViewModel2));
                }
                ...
                inflate.setOnClickListener(new OnClickListener(this) {
                    ...
                    public void onClick(View view) {
                        if (this.f10535c.f10541c != null) {
                            this.f10535c.f10541c.m14397a(tagViewModel2, i6);
                        }
                    }
                });
                    ...
                    textView.setOnClickListener(new OnClickListener(this) {
                        ...
                        public void onClick(View view) {
                            if (this.f10538c.f10542d != null) {
                                this.f10538c.f10542d.m14398a(this.f10538c, tagViewModel2, i6);
                            }
                        }
                    });
