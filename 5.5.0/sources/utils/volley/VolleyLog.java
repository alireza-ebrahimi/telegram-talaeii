...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        protected void finalize() {
            if (!this.mFinished) {
                ...
                VolleyLog.m14407e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
        ...
        public synchronized void finish(String str) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m14406d("(%-4d ms) %s", Long.valueOf(r2), str);
                long j2 = j;
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m14406d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - j2), Long.valueOf(marker.thread), marker.name);
                    j2 = marker.time;
                }
            }
        }
    ...
    /* renamed from: d */
    public static void m14406d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m14407e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m14408e(Throwable th, String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr), th);
    }

    public static void setTag(String str) {
        m14406d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    /* renamed from: v */
    public static void m14409v(String str, Object... objArr) {
        if (DEBUG) {
