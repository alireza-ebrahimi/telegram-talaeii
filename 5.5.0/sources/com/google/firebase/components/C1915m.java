...
final class C1915m {
    ...
    static List<C1902a<?>> m8740a(List<C1902a<?>> list) {
        ...
        for (C1902a c1902a : list) {
            C1914a c1914a2 = new C1914a(c1902a);
            for (Class put : c1902a.m8709a()) {
                if (hashMap.put(put, c1914a2) != null) {
                    throw new IllegalArgumentException(String.format("Multiple components provide %s.", new Object[]{(Class) r4.next()}));
                }
            }
        }
        for (C1914a c1914a3 : hashMap.values()) {
            for (C1905f c1905f : c1914a3.m8735b().m8710b()) {
                C1914a c1914a4;
                if (c1905f.m8721c()) {
                    c1914a4 = (C1914a) hashMap.get(c1905f.m8719a());
                    if (c1914a4 != null) {
                        c1914a3.m8734a(c1914a4);
                        c1914a4.m8736b(c1914a3);
                    }
                }
            }
        }
        ...
        while (!a.isEmpty()) {
            c1914a3 = (C1914a) a.iterator().next();
            a.remove(c1914a3);
            arrayList.add(c1914a3.m8735b());
            for (C1914a c1914a42 : c1914a3.m8733a()) {
                c1914a42.m8737c(c1914a3);
                if (c1914a42.m8738c()) {
                    a.add(c1914a42);
                }
            }
        ...
        for (C1914a c1914a32 : hashSet) {
            if (!(c1914a32.m8738c() || c1914a32.m8739d())) {
                arrayList2.add(c1914a32.m8735b());
            }
        }
