...
public class C5306e extends C0926a<C0955v> {
    ...
    /* renamed from: a */
    public int m14113a(C5304a c5304a) {
        return this.f10212a.indexOf(c5304a);
    }

    /* renamed from: a */
    public C5304a m14114a(int i) {
        return i < m14112a() ? (C5304a) this.f10212a.get(i) : null;
    }

    /* renamed from: a */
    public C5306e m14115a(C5308f c5308f) {
        this.f10213c.b(c5308f.getItemLayoutId(this), c5308f);
        return this;
    }

    /* renamed from: a */
    public void m14116a(C5301a c5301a) {
        this.f10214d = c5301a;
    }

    /* renamed from: b */
    public C5308f m14117b(int i) {
